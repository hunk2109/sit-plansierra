...
//(((((((((((((((((((((((((((((((((((((((((((((((((((((((())))))))))))))))))))))))))))))))))))))))))))))))))))))))
	...
	$.get('index.php?r=sisfam/GetAvances&criterio='+criterio, function (data3){
			data3 = JSON.parse(data3);	
			$.get('index.php?r=sisfam/GetPoa&cuenca='+cuencapoa+'&ano1='+anopoa1+'&ano2='+anopoa2, function (data4){
...
$('#psgrafico91').highcharts({
	...
	$("#psTituloA2").append("<td><h4><b>" +"Actividad de&nbsp;"+ nombreactividad + "&nbsp; Avance/Meta = % de cumplimiento" + "</b></h4></td>" );
		...
		$.get('index.php?r=sisfam/GetAvances&criterio='+criterio, function (data3){
			data3 = JSON.parse(data3);
			/////////////////////////
			act='cantidad productores';
			$.get('index.php?r=sisfam/GetPoa3&cuenca='+cuencapoa+'&ano1='+anopoa1+'&ano2='+anopoa2+'&actividad=\''+act+'\'', function (data4){
			data4 = JSON.parse(data4);	
			//////////////////////////
			var row = $("<tr>");
			$("#psgraficoA2").append(row); 
			row.append($("<td ><h6  align='left ' ><b>Productores con sistemas productivos</b></h6></td>"));		
			...
			$("#psgraficoA2").append(row); 
				...
				var row = $("<tr>");
				$("#psgraficoA2").append(row); 
				row.append($("<td ><h6  align='left ' ><b>Superficie  (tareas)</b></h5></td>"));
				...
				$("#psgraficoA2").append(row); 
					...
					var row = $("<tr>");
					$("#psgraficoA2").append(row); 
					row.append($("<td ><h6  align='left ' ><b>Sistemas de riesgo establecidos</b></h5></td>"));
					row.append($("<td><h5 align='right'>" + parseFloat(data4[0].suma).toFixed(2).toLocaleString('en-EN', {maximumFractionDigits:2,minimunFractionDigits:2}) + "</td>"));
					row.append($("<td><h5 align='right'>" + parseFloat(data3[0].riego).toFixed(2).toLocaleString('en-EN', {maximumFractionDigits:2,minimunFractionDigits:2}) + "</td>"));
					row.append($("<td><h5 align='right'>" + parseFloat(((data3[0].riego*100)/(data4[0].suma))).toFixed(2).toLocaleString('en-EN', {maximumFractionDigits:2,minimunFractionDigits:2}) + "</td>"));
					...
					$("#psgraficoA2").append(row); 
						...
						var row = $("<tr>");
						$("#psgraficoA2").append(row); 
						row.append($("<td ><h6  align='left ' ><b>Superficie bajo riego</b></h5></td>"));
							
						row.append($("<td><h5 align='right'>" + parseFloat(data4[0].suma).toFixed(2).toLocaleString('en-EN', {maximumFractionDigits:2,minimunFractionDigits:2}) + "</td>"));
						row.append($("<td><h5 align='right'>" + parseFloat(data3[0].tareasriego).toFixed(2).toLocaleString('en-EN', {maximumFractionDigits:2,minimunFractionDigits:2}) + "</td>"));
						row.append($("<td><h5 align='right'>" + parseFloat(((data3[0].tareasriego*100)/(data4[0].suma))).toFixed(2).toLocaleString('en-EN', {maximumFractionDigits:2,minimunFractionDigits:2}) + "</td>"));
						var row = $("</tr>");
						$("#psgraficoA2").append(row); 
							...
							var row = $("<tr>");
							$("#psgraficoA2").append(row); 
							row.append($("<td ><h6  align='left ' ><b>Participación en actividades de capacitación</b></h5></td>"));
							row.append($("<td><h5 align='right'>" +parseFloat(data4[0].suma).toFixed(2).toLocaleString('en-EN', {maximumFractionDigits:2,minimunFractionDigits:2}) + "</td>"));
							row.append($("<td><h5 align='right'>" + parseFloat(data3[0].capacitacion).toFixed(2).toLocaleString('en-EN', {maximumFractionDigits:2,minimunFractionDigits:2}) + "</td>"));
							row.append($("<td><h5 align='right'>" +parseFloat(((data3[0].capacitacion*100)/(data4[0].suma))).toFixed(2).toLocaleString('en-EN', {maximumFractionDigits:2,minimunFractionDigits:2}) + "</td>"));
			...
			$("#psgraficoA2").append(row); 
			row.append($("<td ><h6  align='left ' ><b>Producción agroforestal</b></h5></td>"));
			row.append($("<td ><h6  align='left ' ><b> </b></h5></td>"));
			row.append($("<td ><h6  align='left ' ><b> </b></h5></td>"));
			row.append($("<td ><h6  align='left ' ><b> </b></h5></td>"));
			...
			var row = $("<tr>");
			$("#psgraficoA2").append(row); 
			row.append($("<td ><h6  align='right' ><b>Café</b></h5></td>"));
			row.append($("<td><h5 align='right'>" +parseFloat((2.34*data3[0].cafe)).toFixed(2).toLocaleString('en-EN', {maximumFractionDigits:2,minimunFractionDigits:2}) + "</td>"));
			row.append($("<td><h5 align='right'>" +parseFloat( data3[0].cafe).toFixed(2).toLocaleString('en-EN', {maximumFractionDigits:2,minimunFractionDigits:2}) + "</td>"));
			row.append($("<td><h5 align='right'>" + parseFloat(((data3[0].cafe*100)/(2.34*data3[0].cafe))).toFixed(2).toLocaleString('en-EN', {maximumFractionDigits:2,minimunFractionDigits:2}) + "</td>"));
			...
			var row = $("<tr>");
			$("#psgraficoA2").append(row); 
			row.append($("<td ><h6  align='right' ><b>Frutales</b></h5></td>"));
			row.append($("<td><h5 align='right'>" + parseFloat(4.23*data3[0].frutales).toFixed(2).toLocaleString('en-EN', {maximumFractionDigits:2,minimunFractionDigits:2}) + "</td>"));
			row.append($("<td><h5 align='right'>" + parseFloat(data3[0].frutales).toFixed(2).toLocaleString('en-EN', {maximumFractionDigits:2,minimunFractionDigits:2}) + "</td>"));
			row.append($("<td><h5 align='right'>" + parseFloat(((data3[0].frutales*100)/(4.23*data3[0].frutales))).toFixed(2).toLocaleString('en-EN', {maximumFractionDigits:2,minimunFractionDigits:2}) + "</td>"));
			...
			var row = $("<tr>");
			$("#psgraficoA2").append(row); 
			row.append($("<td ><h6  align='right' ><b>Macadamia</b></h5></td>"));
			row.append($("<td><h5 align='right'>" + parseFloat((1.3*data3[0].macadamia)).toFixed(2).toLocaleString('en-EN', {maximumFractionDigits:2,minimunFractionDigits:2}) + "</td>"));
			row.append($("<td><h5 align='right'>" + parseFloat(data3[0].macadamia).toFixed(2).toLocaleString('en-EN', {maximumFractionDigits:2,minimunFractionDigits:2}) + "</td>"));
			row.append($("<td><h5 align='right'>" + parseFloat(((data3[0].macadamia*100)/(1.3*data3[0].macadamia))).toFixed(2).toLocaleString('en-EN', {maximumFractionDigits:2,minimunFractionDigits:2}) + "</td>"));
...
//CLASIFICACION POR GENERO Y ESTADO CIVIL
	...
	$.get('index.php?r=sisfam/GetEstadoCivilGenero&criterio='+criterio, function (data3){
		data3 = JSON.parse(data3);	
		...
		$.get('index.php?r=sisfam/GetTodoGenero&criterio='+criterio, function (data4){
		data4 = JSON.parse(data4);
	
			//datos de la columna
			//carrga datos de genero
		$.get('index.php?r=sisfam/GetEstadoCivil2&criterio='+criterio, function (data5){
			data5 = JSON.parse(data5);
		$.get('index.php?r=sisfam/GetSumaEstadoCivil&criterio='+criterio, function (data6){
...
$.get('index.php?r=sisfam/GetConyuge&criterio='+criterio, function (data3){
	data3 = JSON.parse(data3);	
	$.get('index.php?r=sisfam/GetTodoConyuge&criterio='+criterio, function (data4){
	data4=JSON.parse(data4);
...
$.get('index.php?r=sisfam/GetHijo&criterio='+criterio, function (data3){
	data3 = JSON.parse(data3);	
	$.get('index.php?r=sisfam/GetTodoHijo&criterio='+criterio, function (data4){
	data4=JSON.parse(data4);
...
$.get('index.php?r=sisfam/GetObreros&criterio='+criterio, function (data3){
	data3 = JSON.parse(data3);	
	$.get('index.php?r=sisfam/GetTodoObreros&criterio='+criterio, function (data4){
	data4=JSON.parse(data4);
...
$.get('index.php?r=sisfam/GetMujeres&criterio='+criterio, function (data3){
	data3 = JSON.parse(data3);	
	$.get('index.php?r=sisfam/GetTodoMujeres&criterio='+criterio, function (data4){
	data4=JSON.parse(data4);
...
$("#psgrafico102").empty();
	...
	$.get('index.php?r=sisfam/GetSistemasMunicipio&criterio='+criterio, function (data3){
	data3 = JSON.parse(data3);	
	var totalSup = 0;
	var totalNum = 0;
	var row = $("<tr />");
	...
	////////////////////
		...
		row.append($("<td width=40%><h5 align='center'><b>Cantidad</b></h5></td>"));
		row.append($("<th></th>"));
		//var row = $("<tr />");
		$("#psgrafico102").append(row); 
	...
	$("#psgrafico94").empty();
	if (genero==0){	
	$("#psTitulo94").append("<td><h4><b>" +"Evaluación de los Sistemas Familiares" + "</b></h3></td>" );
	...
	$("#psgrafico94").empty();
		...
		row.append($("<td width=35%><h5 align='center'><b>Calificación</b></h5></td>"));
	...
	$.get('index.php?r=sisfam/GetSistemasSubcuenca&criterio='+criterio, function (data3){
	data3 = JSON.parse(data3);	
	var totalSup = 0;
	var totalNum = 0;
	var row = $("<tr />");
	...
	$("#psgrafico94bis").empty();
		...
		row.append($("<td width=25%><h5 align='center'><b>Subcuenca</b></h5></td>"));
		row.append($("<td width=25%><h5 align='center'><b>Cantidad de participantes</b></h5></td>"));
		row.append($("<td width=25%><h5 align='center'><b>Tareas total</b></h5></td>"));
		row.append($("<td width=25%><h5 align='center'><b>Tareas bajo riego</b></h5></td>"));
		row.append($("<th></th>"));
		//var row = $("<tr />");
	...
	$("#psgrafico95").empty();
	if (genero==0){	
	$("#psTitulo95").append("<td><h4><b>Producción</b></h4></td>" );
 var row = $("<tr>");
		...
		row.append($("<td width=40%><h5 align='left'><b>Producción/ingresos</b></h5></td>"));
		row.append($("<td width=30%><h5 align='center'><b>Producción inicial</b></h5></td>"));
		row.append($("<td width=30%><h5 align='center'><b>Producción actual</b></h5></td>"));
	...
	$.get('index.php?r=sisfam/GetSistemasProduccionCultivos&criterio=  '+criterio, function (data3){
	data3 = JSON.parse(data3);	
	var totalSup = 0;
	var totalNum = 0;
	var row = $("<tr />");
	...
	$.get('index.php?r=sisfam/GetSistemasProduccionActual&criterio=  '+criterio+'&ano=\''+anoactual+'\'', function (data5){
	data5 = JSON.parse(data5);
	$.get('index.php?r=sisfam/GetSistemasProduccionInicial&criterio=  '+criterio, function (data4){
	data4 = JSON.parse(data4);
		...
		for ( var j=0 ; j < data3.length ; j++){
			...
			var row = $("<tr>");
			$("#psgrafico95").append(row); 
			row.append($("<td><h5 align='right'>" + data3[j].cultivo.toLocaleString('en-EN', {maximumFractionDigits:0}) + "</b></h5></td>"));
			var contar=0;
			
			for ( var i=0 ; i < data4.length ; i++){
			   if (data3[j].cultivo == data4[i].cultivo ) {
				   contar=1;
				 row.append($("<td><h5 align='right'>" + data4[i].produccion.toLocaleString('en-EN', {maximumFractionDigits:2,minimumFractionDigits:2 }) + "</b></h5></td>")); 
				 pesosiniciales=pesosiniciales+data4[i].pesos;
			   }
			}
			if (contar==0){
				row.append($("<td><h5 align='right'> 0.00 </b></h5></td>"));
			}

			var contar=0;
			for ( var i=0 ; i < data5.length ; i++){
			   if (data3[j].cultivo == data5[i].cultivo ) {
				   contar=1;
				 row.append($("<td><h5 align='right'>" + data5[i].produccion.toLocaleString('en-EN', {maximumFractionDigits:2,minimumFractionDigits:2 }) + "</b></h5></td>")); 
				  pesosactuales=pesosactuales+data5[i].pesos;
			   }
			}
			if (contar==0){
				row.append($("<td><h5 align='right'> 0.00 </b></h5></td>"));
		...
		row.append($("<td><h5 align='left'><b> Ingresos ($RD)</b></h5></td>"));
		row.append($("<td><h5 align='right'>$RD   " + pesosiniciales.toLocaleString('en-EN', {maximumFractionDigits:2,minimumFractionDigits:2 }) + " </b></h5></td>")); 
		row.append($("<td><h5 align='right'>$RD   " + pesosactuales.toLocaleString('en-EN', {maximumFractionDigits:2,minimumFractionDigits:2 }) + " </b></h5></td>")); 
		var row = $("</tr>");
		$("#psgrafico95").append(row); 		
...
if (genero==0){	
	var row = $("<tr />");
	$("#psTitulo103").append("<td><h4><b>" +" Componentes " + "</b></h3></td>" );
	$("#psgrafico103").append(row); 
		row.append($("<td width=40% class=sucess colspan=2></td>"));
		row.append($("<td width=60% class=sucess colspan=3 ><h5 align='center' ><b>Componentes</b></h5></td>"));
		row.append($("<th></th>"));
		var row = $("<tr style='background-color:white' >");
		 $("#psgrafico103").append(row); 
	    var row = $("<tr >");
		$("#psgrafico102").append(row); 
		row.append($("<td width=25%><h5 align='center'><b>Descripcion</b></h5></td>"));
		row.append($("<td width=15%><h5 align='center'><b>Código</b></h5></td>"));
		row.append($("<td width=20%><h5 align='center'><b>Diagnóstico</b></h5></td>"));
		row.append($("<td width=20%><h5 align='center'><b>Propuesto</b></h5></td>"));
		row.append($("<td width=20%><h5 align='center'><b>Establecido</b></h5></td>"));
		row.append($("<th></th>"));
		//var row = $("<tr />");
		
		$("#psgrafico103").append(row); 
	$.get('index.php?r=sisfam/GetComponentesPorAnalisis&criterio='+criterio, function (data3){
	...
	var c = 0, s =0;
		...
		for (var l=0; l < data3.length; l++){
					...
					row.append($("<td><h5 >" + data3[l].descripcion.toLocaleString('en-EN') + "</td>"));
				
					row.append($("<td><h5 align='left' >" + data3[l].codigo.toLocaleString('en-EN', {maximumFractionDigits:1}) + "</td>"));
					row.append($("<td><h5 align='right' >" + data3[l].diagnostico.toLocaleString('en-EN', {maximumFractionDigits:1}) + "</td>"));
					row.append($("<td><h5 align='right' >" + data3[l].instalar.toLocaleString('en-EN', {maximumFractionDigits:1}) + "</td>"));
					row.append($("<td><h5 align='right' >" + data3[l].establecido.toLocaleString('en-EN', {maximumFractionDigits:1}) + "</td>"));
					var row = $("</tr>");
