...
/**
 * This is the model class for table "geo_isopolygon".
 *
 * The followings are the available columns in table 'geo_isopolygon':
 ...
 */
class GeoIsopolygon extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return GeoIsopolygon the static model class
	 */
