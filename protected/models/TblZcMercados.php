...
/**
 * This is the model class for table "tbl_zc_mercados".
 *
 * The followings are the available columns in table 'tbl_zc_mercados':
 * @property integer $id
 ...
 */
class TblZcMercados extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return TblZcMercados the static model class
	 */
	...
	public function rules()
	{
		...
		return array(
			array('cod_zipcode, id_mercado', 'numerical', 'integerOnly'=>true),
			array('cp, venta_si, venta_no, venta_ns, folleto_si, folleto_no, folleto_ns', 'safe'),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('id, cod_zipcode, id_mercado, cp, venta_si, venta_no, venta_ns, folleto_si, folleto_no, folleto_ns', 'safe', 'on'=>'search'),
		);
	}
