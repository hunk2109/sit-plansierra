...
$(document).ready(function () {
			...
			$.get("index.php?r=TblZonaInfluencia/getByZone&idAlcampo="+idAlcampo+"&zone=1", function(data){
				for(var loc in data){
					...
					loc = new ol.layer.Image({
						...
						url: 'http://<?php echo Yii::app()->params['servidor'];?>/cgi-bin/mapserv.exe?MAP=c:\\datos/sigma/maps/sigma_3857.map&loc='+cod,
						crossorigin: 'anonymous',
							params: {'LAYERS': 'loc', 'SRS': "EPSG:3857"}
						})
					})
					map.addLayer(loc);
			   infoCP();
	...
	$('#hiperAlcampo').selectmenu({
		change: function( event, data ) {
			...
			$.get('index.php?r=tblIdEncuesta/getAll&id='+idAlcampo, function(data2){
				...
				$.get('index.php?r=geoZonaInfluencia/getExtent&epsg=3857&id='+data2[0].id_encuesta, function (d){
				...
				zi.getSource().setUrl("http://<?php echo Yii::app()->params['servidor'];?>/cgi-bin/mapserv.exe?MAP=c:\\datos/sigma/maps/sigma_3857.map&hiper="+idAlcampo);
				//principales.getSource().setUrl("http://<?php echo Yii::app()->params['servidor'];?>/cgi-bin/mapserv.exe?MAP=c:\\datos/sigma/maps/sigma_3857.map&id_encuesta="+idEncuesta);
				//c_totales.getSource().setUrl("http://<?php echo Yii::app()->params['servidor'];?>/cgi-bin/mapserv.exe?MAP=c:\\datos/sigma/maps/sigma_3857.map&id_encuesta="+idEncuesta);
	...
	*/
	...
	zi = new ol.layer.Image({
		...
		url: 'http://<?php echo Yii::app()->params['servidor'];?>/cgi-bin/mapserv.exe?MAP=c:\\datos/sigma/maps/sigma_3857.map&alcampo=1&SERVICE=WMS&VERSION=1.3.0&REQUEST=GetLegendGraphic&FORMAT=image/png&SLD_VERSION=1.1.0&LAYER=ZONAS_INFLUENCIA',
		source: new ol.source.ImageWMS({
		url: 'http://<?php echo Yii::app()->params['servidor'];?>/cgi-bin/mapserv.exe?MAP=c:\\datos/sigma/maps/sigma_3857.map&alcampo=1',
		crossorigin: 'anonymous',
			params: {'LAYERS': 'ZONAS_INFLUENCIA', 'SRS': "EPSG:3857" }
		})
	})
	...
	/*principales = new ol.layer.Image({
		...
		visible:false,
		url: 'http://<?php echo Yii::app()->params['servidor'];?>/cgi-bin/mapserv.exe?MAP=c:\\datos/sigma/maps/sigma_3857.map&zc=1&SERVICE=WMS&VERSION=1.3.0&REQUEST=GetLegendGraphic&FORMAT=image/png&SLD_VERSION=1.1.0&LAYER=CLIENTES_PRINCIPALES',
		source: new ol.source.ImageWMS({
			url: 'http://<?php echo Yii::app()->params['servidor'];?>/cgi-bin/mapserv.exe?MAP=c:\\datos/sigma/maps/sigma_3857.map&zc=1',
			crossorigin: 'anonymous',
				params: {'LAYERS': 'CLIENTES_PRINCIPALES', 'SRS': "EPSG:3857" }
			})
	})
	...
	c_totales = new ol.layer.Image({
		...
		visible:false,
		url: 'http://<?php echo Yii::app()->params['servidor'];?>/cgi-bin/mapserv.exe?MAP=c:\\datos/sigma/maps/sigma_3857.map&zc=1&SERVICE=WMS&VERSION=1.3.0&REQUEST=GetLegendGraphic&FORMAT=image/png&SLD_VERSION=1.1.0&LAYER=CLIENTES_TOTALES',
		source: new ol.source.ImageWMS({
			url: 'http://<?php echo Yii::app()->params['servidor'];?>/cgi-bin/mapserv.exe?MAP=c:\\datos/sigma/maps/sigma_3857.map&zc=1',
			crossorigin: 'anonymous',
				params: {'LAYERS': 'CLIENTES_TOTALES', 'SRS': "EPSG:3857" }
			})
	})*/
