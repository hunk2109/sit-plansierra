...
var nombreactividad="Reforestación (actividad 1)";
/*
var f = new Date();
...
$('#grafico91').highcharts({
    ...
    series: [{
		...
		//cuadro de avances 
       	...
       	$("#TituloA2").append("<td><h3><b>" +"Actividad de&nbsp;"+ nombreactividad + "&nbsp; Avance / Meta = % de cumplimiento" + "</b></h4></td>" );
	...
	var c = 0, s =0;
		...
		$("#Titulo92").append("<td><h3><b>" +" Tipo actividad de &nbsp;"+nombreactividad + "</b></h4></td>" );
	$('#grafico92').empty();
	 var row = $("<tr />");
	...
	$("#Titulo93").append("<td><h3><b>" +"Tipo de Actividad por Subcuenca (Tareas)" + "</b></h3></td>" );
...
//primera actividad
	...
	*/
	$("#Titulo104").append("<td><h3><b>" +"Grupo de especie (salidas vivero)" + "</b></h4></td>" );
...
*/
	...
	var c = 0, s =0;
		...
		$("#Titulo102").append("<td><h3><b>" +" Superficies resforestada por Municipios" + "</b></h4></td>" );
	...
	$("#Titulo94").append("<td><h3><b>" +"Especies plantadas en la actividad de  &nbsp;"+nombreactividad + "</b></h3></td>" );
	...
	//$("#Titulo94sub").append("<td><h5>" +data4[0].actividad+ "</h5></td>" );
		...
		//plantas por especie y plantacion
		
		var sumatotales=[];
		for (var l=0; l < (2+2*data4.length);l++){
			sumatotales[l]=0;
		}
		// bucle de por especies
				for (var i=0; i < data5.length; i++){
					row.append($("<td>" +  "</td>"));
	...
	//POR DESTINO
	$("#Titulo95").append("<td witdht=100%><h3><b>" +"Superficie de reforestación por destino" + "</center></b></h3></td>" );
	//////////////////////////////////////////////////////
	//////////////////////////////////////////////////////////////////////////////
