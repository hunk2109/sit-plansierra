					...
					<div class="tab-content">
						<div id="menu0" class="tab-pane fade in active">
							  <div class="row">
										...
										<div class="row">	
											  <div class="col-md-12">
											    <h4 id="psTitulo95a" width="100%" class="p-3 mb-2 bg-danger   text-white  ".bg-success></h4>
												
												<div class="table">
													<table id="psgrafico95a" class="table-striped bg-danger text-white" ></table>
												</div>
										    </div>
									...
									<div class="row">	
											  <div class="col-md-12">
											    <h4 id="psTitulo95b" width="100%" class="p-3 mb-2 bg-danger   text-white  ".bg-success></h4>
												
												<div class="table">
													<table id="psgrafico95b" class="table-striped bg-danger text-white" ></table>
												</div>
										    </div>
									...
									<div class="row">	
											  <div class="col-md-12">
											    <h4 id="psTitulo95c" width="100%" class="p-3 mb-2 bg-danger   text-white  ".bg-success></h4>
												
												<div class="table">
													<table id="psgrafico95c" class="table-striped bg-danger text-white" ></table>
												</div>
										    </div>
...
INSERTA LAS LIBRERIAS DEL PLANSIERRA
...
<script src="js/cargarcafecue.js" type="text/javascript"></script>

<script src="js/cargarcafepsi.js" type="text/javascript"></script>
...
var nombreactividad="Sistema de Producción Café";
