...
function cargarGraficoAnoCuenca(){
	...
	$("#grafico80").append("</td>   <td ><h4><b>Fecha  : " +dia+ "    Año " +id2+ "   Subcuenca : "+idAlcampo+" , Reforestación</b></h4></td> " );
...
$('#grafico91').highcharts({
   ...
   $.get('index.php?r=Poa/GetActividadActividadSubcuenca&tipoactividad='+tipoactividad+'&ano='+ano+'&subcuenca='+idAlcampo,  function (data3){
	...
	$.get('index.php?r=Poa/GetActividadActividadSubcuencaListadoParcelas&tipoactividad='+tipoactividad+'&ano='+ano+'&subcuenca='+idAlcampo,  function (data3){
	data3 = JSON.parse(data3);	
	var totalSup = 0;
	var totalNum = 0;
	var row = $("<tr />");
	...
	var c = 0, s =0;
		$("#Titulo93").empty();
		$("#Titulo93").append("<td><h5>" +"Tipo de Plantacion por Microcuenca" + "</h5></td>" );
	 var row = $("<tr />");
	...
	$.get('index.php?r=Poa/GetMunicipioActividadSubcuencas&tipoactividad='+tipoactividad+'&ano='+ano+'&subcuenca='+idAlcampo, function (data3){
	data3 = JSON.parse(data3);	
	var totalSup = 0;
	var totalNum = 0;
	var row = $("<tr />");
	...
	$.get('index.php?r=Poa/GetEspecieActividadPlantadasSubcuencas&tipoactividad='+tipoactividad+'&ano='+ano+'&subcuenca='+idAlcampo, function (data3){
	data3 = JSON.parse(data3);	
	var totalSup = 0;
	var totalNum = 0;
	var row = $("<tr />");
	...
	$.get('index.php?r=Poa/GetProyectoActividadSubcuenca&tipoactividad='+tipoactividad+'&ano='+ano+'&subcuenca='+idAlcampo, function (data3){
	data3 = JSON.parse(data3);	
	var totalSup = 0;
	var totalNum = 0;
	var row = $("<tr />");
