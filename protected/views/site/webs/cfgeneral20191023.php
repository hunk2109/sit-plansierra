...
function cargarGraficoAno(){
	...
	$("#grafico80").append("</td>   <td ><h3><b>&nbsp; Fecha de consulta :&nbsp; " +dia+ ", (desde: " +finicial2+"&nbsp; a&nbsp;: "+ffinal2+"&nbsp;) </b></h3></td> " );
...
$('#grafico91').highcharts({
    ...
    series: [{
		...
		//cuadro de avances 
       	...
       	$("#TituloA2").append("<td><h4>" +"Actividad de&nbsp;"+ nombreactividad + "&nbsp; Avance / Meta = % de cumplimiento" + "</h4></td>" );
	...
	var c = 0, s =0;
		...
		$("#Titulo92").append("<td><h4>" +" Tipo actividad de &nbsp;"+nombreactividad + "</h4></td>" );
	$('#grafico92').empty();
	 var row = $("<tr />");
	...
	$("#Titulo93").append("<td><h4>" +"Tipo de Actividad por Subcuenca (Tareas)" + "</h4></td>" );
...
//primera actividad
	...
	$("#Titulo104").append("<td><h4>" +"Grupo de especie (salidas vivero)" + "</h4></td>" );
...
$.get('index.php?r=Poa/GetEspecieActividad&tipoactividad=0&tipoactividadsec='+tipoactividadsec+'&finicial='+finicial+'&ffinal='+ffinal, function (data3){
	...
	var c = 0, s =0;
		...
		$("#Titulo102").append("<td><h4>" +" Superficies resforestada por Municipios" + "</h4></td>" );
	...
	$("#Titulo94").append("<td><h4>" +"Especies plantadas en la actividad de  &nbsp;"+nombreactividad + "</h4></td>" );
	...
	$("#Titulo94sub").append("<td><h5>" +data4[0].actividad+ "</h5></td>" );
		...
		var row = $("<tr />");
			...
			row.append($("<th></th>"));
			row.append($("<td><h4><b>"+ "TOTAL" +"</b></h4></td>"));
			for (var j=0; j < (2+2*data4.length); j++){
			row.append($("<td><h4><b>" + sumatotales[j].toLocaleString('en-EN', {maximumFractionDigits:1}) + "</b></h4></td>"));	
			}
		var row = $("<tr />");
	...
	$.get('index.php?r=Poa/GetEspecieActividadPlantadas&tipoactividad=0&tipoactividadsec='+tipoactividadsec+'&finicial='+finicial+'&ffinal='+ffinal, function (data3){
	data3 = JSON.parse(data3);	
	var totalSup = 0;
	var totalNum = 0;
	var row = $("<tr />");
	...
	$.get('index.php?r=Poa/GetActividadActividad&tipoactividad=0&tipoactividadsec='+tipoactividadsec+'&finicial='+finicial+'&ffinal='+ffinal, function (data4){
	data4 = JSON.parse(data4);
		$.get('index.php?r=Poa/GetEspecieUtilizadasActividad&tipoactividad=0&tipoactividadsec='+tipoactividadsec+'&finicial='+finicial+'&ffinal='+ffinal, function (data5){
			data5 = JSON.parse(data5);

	$("#Titulo94bis").append("<td><h5>" +data4[0].actividad+ "</h5></td>" );
	
	
		
		 var row = $("<tr />");
		$("#grafico94bis").append(row); 
	...
	var c = 0, s =0;
		...
		$("#Titulo103").append("<td><h4>" +"Superficie de reforestación por fondo" + "</h4></td>" );
