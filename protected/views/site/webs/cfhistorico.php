...
//alert ('año'+id2);
	...
	$.get('index.php?r=Estadisticas/GetContarEspeciesActividad&tipoactividad='+tipoactividad, function (data3){
	data3 = JSON.parse(data3);	
	var totalSup = 0;
	var totalNum = 0;
	var row = $("<tr />");
	...
	$.get('index.php?r=Estadisticas/GetContarPlantacionActividad&tipoactividad='+tipoactividad, function (data3){
	data3 = JSON.parse(data3);	
	var totalSup = 0;
	var totalNum = 0;
	var row = $("<tr />");
	...
	$.get('index.php?r=Estadisticas/GetContarProyectosActividad&tipoactividad='+tipoactividad, function (data3){
	data3 = JSON.parse(data3);	
	var totalSup = 0;
	var totalNum = 0;
	var row = $("<tr />");
	...
	var c = 0, s =0;
		...
		$.get('index.php?r=Estadisticas/GetContarProyectosNosigActividad&tipoactividad='+tipoactividad, function (data4){
	    data4 = JSON.parse(data4);	
		//alert (data4.length);
...
$.get('index.php?r=Graficos/GetPSActividad&tipoactividad='+tipoactividad, function (data){
	//$.get('index.php?r=Graficos/GetAno&id='+id2, function (data){
...
*/
	...
	$.get('index.php?r=Estadisticas/GetAreaParcelaActividad&tipoactividad='+tipoactividad, function (data){
	//$.get('index.php?r=Graficos/GetAno&id='+id2, function (data){
	//var data=[];
	data = JSON.parse(data);
...
$('#grafico21').highcharts({
 ...
 colors: ['#990000','#00ff00', '#0000ff', '#990000','#009900', '#000099', '#999900','#00ff99', '#9944ff'],
            ...
            title: {
                text: 'Distribución de las superficies de las plantaciones'
            },
            subtitle: {
                text: document.ontouchstart === undefined ?
                    'Pulse y arrastre en el grafico para hacer zoom' : 'Pinch the chart to zoom in'
	...
	$.get('index.php?r=Estadisticas/GetPSAnoActividad&tipoactividad='+tipoactividad, function (data){
	//$.get('index.php?r=Graficos/GetAno&id='+id2, function (data){
	//var data=[];
	data = JSON.parse(data);
...
//tabla
 ...
 // segunda columna
$.get('index.php?r=Graficos/GetPSsubActividad&tipoactividad='+tipoactividad, function (data){
	//$.get('index.php?r=Graficos/GetAno&id='+id2, function (data){
...
$.get('index.php?r=Graficos/GetPSAnoEspeciesActividad&tipoactividad='+tipoactividad, function (data){
	//$.get('index.php?r=Graficos/GetAno&id='+id2, function (data){
	//var data=[];
	data = JSON.parse(data);
	//alert('sali');
...
$.get('index.php?r=Graficos/GetPSsubAnoCuencasActividad&tipoactividad='+tipoactividad, function (data){
	//$.get('index.php?r=Graficos/GetAno&id='+id2, function (data){
	//var data=[];
