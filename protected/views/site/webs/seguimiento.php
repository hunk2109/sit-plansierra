		...
		<div id="popup-content2">
			...
			<!--a href="#" id="popup-closer" class="ol-popup-closer"></a-->
			  <div id="popup-content">
				<div id="tabs">
				  <ul>
					<li><a href="#tabs-1">Reforestación</a></li>
					<li><a href="#tabs-2">Cafe</a></li>
					<li><a href="#tabs-3">Reforestación con Guama</a></li>
					<li><a href="#tabs-4">Sistemas Familiares</a></li>
					<li><a href="#tabs-5">Macadamia</a></li>	
					<li><a href="#tabs-6">Ganaderia</a></li>
				  </ul>
				  
					<div id="tabs-1">
					
				  			    
											<!-- REFORESTACION <div id="map" style="width:100%; height:80%"></div>		-->	
										<div class="row">
											<div class="col-md-8" >
							...
							<div id="tabs-2">			
										<!-- CAFE <div id="map" style="width:100%; height:80%"></div>		-->	
										<div class="row">
											<div class="col-md-8" >
												<div id="grafico280"></div>
											</div>
											<div class="col-md-4" >
												<div id="grafico280_A"></div>
											</div>
										</div>	
										
										<div class="row">
											<div class="col-md-8" >
												<div id="graficoS280"></div>
											</div>
											<div class="col-md-4" >
												<div id="graficoS280_A"></div>
											</div>
										</div>	
										...
										<div class="row">
											...
											<div class="col-md-3">
													<div id="grafico290"></div>
											</div>

											<div class="col-md-3">
											    <div id="grafico291"></div>	
											</div>
											<div class="col-md-2">
											    <h4 id="Titulo292" width="100%" class="p-3 mb-2 bg-danger   text-white  ".bg-success></h4>
												<!--<div id="grafico92"></div>-->
												<div class="table">
													<table id="grafico292" class="table-striped bg-danger text-white" ></table>
												</div>
											</div>
											<div class="col-md-2">
											    <h4 id="Titulo293" width="100%" class="p-3 mb-2 bg-danger   text-white  ".bg-success></h4>
												<!--<div id="grafico92"></div>-->
												<div class="table">
													<table id="grafico293" class="table-striped bg-danger text-white" ></table>
												</div>
											</div>
											<div class="col-md-2">
											    <h4 id="Titulo294" width="100%" class="p-3 mb-2 bg-danger   text-white  ".bg-success></h4>
												<!--<div id="grafico92"></div>-->
												<div class="table">
													<table id="grafico294" class="table-striped bg-danger text-white" ></table>
												</div>
											</div>
											<
										</div>
										...
										<div class="row">
											...
											<div class="col-md-3" >
												<div id="grafico2100"></div>
											</div>
											<div class="col-md-3">
											    <div id="grafico2101"></div>	
											</div>
											<div class="col-md-2">
											    <h4 id="Titulo102" width="74%" class="p-3 mb-2 bg-danger   text-white  ".bg-success></h4>
												<!--<div id="grafico92"></div>-->
												<div class="table">
													<table id="grafico2102" class="table-striped bg-danger text-white" ></table>
												</div>
											</div>
											<div class="col-md-2">
											    <h4 id="Titulo2103" width="74%" class="p-3 mb-2 bg-danger   text-white  ".bg-success></h4>
												<!--<div id="grafico92"></div>-->
												<div class="table">
													<table id="grafico2103" class="table-striped bg-danger text-white" ></table>
												</div>
											</div>
											<div class="col-md-2">
											    <h4 id="Titulo2104" width="74%" class="p-3 mb-2 bg-danger   text-white  ".bg-success></h4>
												<!--<div id="grafico92"></div>-->
												<div class="table">
													<table id="grafico2104" class="table-striped bg-danger text-white" ></table>
												</div>
											</div>
											<
										</div>
							...
							<div id="tabs-4">		
									...
									<!-- SISTEMA FAMILIAR <div id="map" style="width:100%; height:80%"></div>		-->	
										<div class="row">
											<div class="col-md-8" >
												<div id="grafico480"></div>
											</div>
											<div class="col-md-4" >
												<div id="grafico480_A"></div>
											</div>
										</div>	
										
										<div class="row">
											<div class="col-md-8" >
												<div id="graficoS480"></div>
											</div>
											<div class="col-md-4" >
												<div id="graficoS480_A"></div>
											</div>
										</div>	
										...
										<div class="row">
											...
											<div class="col-md-3">
													<div id="grafico490"></div>
											</div>

											<div class="col-md-3">
											    <div id="grafico491"></div>	
											</div>
											<div class="col-md-2">
											    <h4 id="Titulo492" width="100%" class="p-3 mb-2 bg-danger   text-white  ".bg-success></h4>
												<!--<div id="grafico92"></div>-->
												<div class="table">
													<table id="grafico492" class="table-striped bg-danger text-white" ></table>
												</div>
											</div>
											<div class="col-md-2">
											    <h4 id="Titulo493" width="100%" class="p-3 mb-2 bg-danger   text-white  ".bg-success></h4>
												<!--<div id="grafico92"></div>-->
												<div class="table">
													<table id="grafico493" class="table-striped bg-danger text-white" ></table>
												</div>
											</div>
											<div class="col-md-2">
											    <h4 id="Titulo494" width="100%" class="p-3 mb-2 bg-danger   text-white  ".bg-success></h4>
												<!--<div id="grafico92"></div>-->
												<div class="table">
													<table id="grafico494" class="table-striped bg-danger text-white" ></table>
												</div>
											</div>
											<
										</div>
										...
										<div class="row">
											...
											<div class="col-md-3" >
												<div id="grafico4100"></div>
											</div>
											<div class="col-md-3">
											    <div id="grafico4101"></div>	
											</div>
											<div class="col-md-2">
											    <h4 id="Titulo102" width="74%" class="p-3 mb-2 bg-danger   text-white  ".bg-success></h4>
												<!--<div id="grafico92"></div>-->
												<div class="table">
													<table id="grafico4102" class="table-striped bg-danger text-white" ></table>
												</div>
											</div>
											<div class="col-md-2">
											    <h4 id="Titulo4103" width="74%" class="p-3 mb-2 bg-danger   text-white  ".bg-success></h4>
												<!--<div id="grafico92"></div>-->
												<div class="table">
													<table id="grafico4103" class="table-striped bg-danger text-white" ></table>
												</div>
											</div>
											<div class="col-md-2">
											    <h4 id="Titulo4104" width="74%" class="p-3 mb-2 bg-danger   text-white  ".bg-success></h4>
												<!--<div id="grafico92"></div>-->
												<div class="table">
													<table id="grafico4104" class="table-striped bg-danger text-white" ></table>
												</div>
											</div>
											<
										</div>
...
?>
	...
	cargarGraficoAnoCafe();
    cargarGraficoAnoFamiliar();
	 $('#grafico80_A').empty();
...
function cargarGraficoAnoGanaderia(){
	...
	$("#graficoT80").append("</td>   <td ><h4><b>Fecha actual: " +dia+ "  </b></h4></td> " );
	//$("#grafico80_A").html('<img id="loading-image" width=200 src="images/logo3_75_75.gif" alt="Loading..." />');
	//$("#grafico80_A").html('<img id="loading-image" width=200 src="images/logo3_75_75.gif" alt="Loading..." />');
	
	$("#graficoT80_A").html('<img  id="loading-image2" width=64 src="images/ganaderia.png" alt="Loading..."/>' );
		$('#graficoS90').empty();
		$('#graficoS91').empty();
		$('#graficoS92').empty();
		$('#graficoS93').empty();
...
function cargarGraficoAnoReforestacion(){
	...
	$("#grafico80").append("</td>   <td ><h4><b>Fecha actual: " +dia+ "</b></h4></td> " );
	$("#grafico80_A").html('<img id="loading-image" width=200 src="images/logo3_75_75.gif" alt="Loading..." />');
...
function cargarGraficoAnoCafe(){
	...
	$("#grafico280").append("</td>   <td ><h4><b>Fecha actual: " +dia+ "</b></h4></td> " );
	$("#grafico280_A").html('<img id="loading-image" width=200 src="images/logo3_75_75.gif" alt="Loading..." />');
	$("#graficoS280").html('<img  id="loading-image2" width=64 src="images/cafe.png" alt="Loading..."/>' );
		$('#grafico290').empty();
		$('#grafico291').empty();
		$('#grafico292').empty();
		$('#grafico293').empty();
		...
		$("#grafico2101").html('<img id="loading-image" width=80 src="images/logo3_75_75.gif" alt="Loading..." />');
		$("#grafico291").html('<img id="loading-image" width=80 src="images/logo3_75_75.gif" alt="Loading..." />');
	  $('#pobEdad0').empty();
		$('#pobEdad1').empty();
		$('#pobEdad2').empty();
		$('#pobEdad3').empty();
...
$('#grafico291').highcharts({
	...
	var c = 0, s =0;
		...
		$("#Titulo292").append("<td><h5>" +" Tipo de Plantación" + "</h5></td>" );
	$('#grafico292').empty();
	 var row = $("<tr />");
		$("#grafico292").append(row); 
		row.append($("<th></th>"));
		row.append($("<td width=60%><h5><b>Actividad</b></h5></td>"));
	...
	var c = 0, s =0;
		...
		$("#Titulo293").append("<td><h5>" +"Tipo de Plantacion por Subcuenca" + "</h5></td>" );
	
	 var row = $("<tr />");
		$("#grafico293").append(row); 
		row.append($("<th></th>"));
		row.append($("<td width=20%<h5><b>Subcu.</b></h5></td>"));
		row.append($("<td width=60%><h5><b>Tipo</b></h5></td>"));	
		//row.append($("<td width=100><h4><b>Plantaciones</b></h5></td>"));
	...
	var c = 0, s =0;
		...
		$("#Titulo2104").append("<td><h5>" +"Grupo de especie (salidas vivero)" + "</h5></td>" );
	
	 var row = $("<tr />");
		$("#grafico2104").append(row); 
		row.append($("<th></th>"));
		row.append($("<td width=40%><h5><b>Tipo</b></h5></td>"));
			row.append($("<td width=40%><h5><b>Grupo</b></h5></td>"));
		row.append($("<td width=20%><h5><b>Plantas</b></h5></td>"));
	...
	var c = 0, s =0;
		...
		$("#Titulo2102").append("<td><h5>" +" Municipios" + "</h5></td>" );
	
	    var row = $("<tr />");
		$("#grafico2102").append(row); 
		row.append($("<th></th>"));
		row.append($("<td width=60%><h5><b>Municipio</b></h5></td>"));
	...
	var c = 0, s =0;
		...
		$("#Titulo294").append("<td><h5>" +"Epecies plantadas" + "</h5></td>" );
	
	 var row = $("<tr />");
		$("#grafico294").append(row); 
		row.append($("<th></th>"));
		row.append($("<td width=40%><h5><b>Tipo</b></h5></td>"));
		row.append($("<td width=20%><h5><b>Familia</b></h5></td>"));
		row.append($("<td width=20%><h5><b>Plantas</b></h5></td>"));
	...
	var c = 0, s =0;
		...
		$("#Titulo2103").append("<td><h5>" +"Proyectos" + "</h5></td>" );
	
	 var row = $("<tr />");
		$("#grafico2103").append(row); 
		row.append($("<th></th>"));
		row.append($("<td width=60%><h5><b>Proyecto</b></h5></td>"));
...
function cargarGraficoAnoFamiliar(){
		//plantaciones_ano_en_curso.getSource().setUrl("http://sit.plansierra.org/cgi-bin/mapserv.exe?MAP=c:\\datos/sierra/especies.map&ano=2018&doy=161");
		tipoactividad=4;
	$('#grafico480').empty();
	...
	$("#grafico480").append("</td>   <td ><h4><b>Fecha actual: " +dia+ "</b></h4></td> " );
	$("#grafico480_A").html('<img id="loading-image" width=200 src="images/logo3_75_75.gif" alt="Loading..." />');
	$("#graficoS480").html('<img  id="loading-image2" width=64 src="images/sistemas_fam.png" alt="Loading..."/>' );
		$('#grafico490').empty();
		$('#grafico491').empty();
		$('#grafico492').empty();
		$('#grafico493').empty();
		...
		$("#grafico4101").html('<img id="loading-image" width=80 src="images/logo3_75_75.gif" alt="Loading..." />');
		$("#grafico491").html('<img id="loading-image" width=80 src="images/logo3_75_75.gif" alt="Loading..." />');
	  $('#pobEdad0').empty();
		$('#pobEdad1').empty();
		$('#pobEdad2').empty();
		$('#pobEdad3').empty();
...
$('#grafico291').highcharts({
	...
	var c = 0, s =0;
		...
		$("#Titulo492").append("<td><h5>" +" Tipo de Plantación" + "</h5></td>" );
	$('#grafico492').empty();
	 var row = $("<tr />");
		$("#grafico492").append(row); 
		row.append($("<th></th>"));
		row.append($("<td width=60%><h5><b>Actividad</b></h5></td>"));
	...
	var c = 0, s =0;
		...
		$("#Titulo493").append("<td><h5>" +"Tipo de Plantacion por Subcuenca" + "</h5></td>" );
	
	 var row = $("<tr />");
		$("#grafico493").append(row); 
		row.append($("<th></th>"));
		row.append($("<td width=20%<h5><b>Subcu.</b></h5></td>"));
		row.append($("<td width=60%><h5><b>Tipo</b></h5></td>"));	
		//row.append($("<td width=100><h4><b>Plantaciones</b></h5></td>"));
	...
	var c = 0, s =0;
		...
		$("#Titulo4104").append("<td><h5>" +"Grupo de especie (salidas vivero)" + "</h5></td>" );
	
	 var row = $("<tr />");
		$("#grafico4104").append(row); 
		row.append($("<th></th>"));
		row.append($("<td width=40%><h5><b>Tipo</b></h5></td>"));
			row.append($("<td width=40%><h5><b>Grupo</b></h5></td>"));
		row.append($("<td width=20%><h5><b>Plantas</b></h5></td>"));
	...
	var c = 0, s =0;
		...
		$("#Titulo4102").append("<td><h5>" +" Municipios" + "</h5></td>" );
	
	    var row = $("<tr />");
		$("#grafico4102").append(row); 
		row.append($("<th></th>"));
		row.append($("<td width=60%><h5><b>Municipio</b></h5></td>"));
	...
	var c = 0, s =0;
		...
		$("#Titulo494").append("<td><h5>" +"Epecies plantadas" + "</h5></td>" );
	
	 var row = $("<tr />");
		$("#grafico494").append(row); 
		row.append($("<th></th>"));
		row.append($("<td width=40%><h5><b>Tipo</b></h5></td>"));
		row.append($("<td width=20%><h5><b>Familia</b></h5></td>"));
		row.append($("<td width=20%><h5><b>Plantas</b></h5></td>"));
	...
	var c = 0, s =0;
		...
		$("#Titulo4103").append("<td><h5>" +"Proyectos" + "</h5></td>" );
	
	 var row = $("<tr />");
		$("#grafico4103").append(row); 
		row.append($("<th></th>"));
		row.append($("<td width=60%><h5><b>Proyecto</b></h5></td>"));
...
//FIN DE FUNCION SISTEMA FAMILIAR
