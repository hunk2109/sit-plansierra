			...
			<div id="popup-content">
				<div id="tabs">
				  <ul>
					...
					<!--<li><a href="#tabs-4">Especies</a></li></li>-->
					<!--<li><a href="#tabs-6">Especies_detallado</a></li>	</li>-->
					<!--<li><a href="#tabs-7">Labores</a></li></li>-->
					<!--<li><a href="#tabs-5">Predios</a></li></li>-->
					<!--<li><a href="#tabs-8">Cliente</a></li></li>-->
...
var sel, selLayer, osm, google, google_carto,parcelassel,sal,salid,codigobuscado,solo_plantaciones,dataano,dataespecie, dataanocu, datacuenca,fechaini,fechafin,fechainit,fechafint, labor,labort;
...
$(document).ready(function () {
	...
	$('#hiperAlcampo').selectmenu({
		change: function( event, data ) {
			...
			labor='Plantación';
			labort="'"+labor+"'";
			//alert (fechainit+fechafint+labort+cuenca);
...
function cargarGraficoAno(){
	  ...
	  $('#pobEdad0').empty();
		...
		$("#infoTablaCorta").html('<img id="loading-image" width=75 src="images/logo3_75_75.gif" alt="Loading..." />');
...
//alert ('año'+id2);
	...
	$.get('index.php?r=Estadisticas/GetSubCuencaTotal&labor='+labort+'&cuenca='+cuenca+'&fechaini='+fechainit +'&fechafin='+fechafint , function (data3){
	...
	$("#Titulo1").append("<td>" +"Plantaciones (tareas o m)" + "</td>" );
	 ...
	 var row = $("<tr />");
		...
		row.append($("<th></th>"));
		row.append($("<td width=100><h5><b>Subcuenca</b></h5></td>"));
		...
		for (var i=0; i < data3.length; i++){
			...
			row.append($("<td><h6>" + data3[i].cuenca.toLocaleString('en-EN') + "</td>"));
	...
	$.get('index.php?r=Estadisticas/GetSubCuencaTotalEspeciePlantar&labor='+labort+'&cuenca='+cuenca+'&fechaini='+fechainit +'&fechafin='+fechafint , function (data3){
	...
	$("#Titulo2").append("<td>" +"Especies a plantar" + "</td>" );
	
	 var row = $("<tr />");
		$("#infoTablaLarga").append(row); 
		row.append($("<th></th>"));
		row.append($("<td width=400><h5><b>Especie Plantar</b></h5></td>"));
		row.append($("<td width=100><h5><b>Unidad</b></h5></td>"));
			var row = $("<tr />")	
			$("#infoTablaLarga").append(row); 
	...
	$.get('index.php?r=Estadisticas/GetSubContarEspeciesFechaCuenca&cuenca='+cuenca+'&fechaini='+fechainit +'&fechafin='+fechafint , function (data3){
	...
	$("#Titulo3").append("<td>" +"Grupos de especies" + "</td>" );
	...
	$.get('index.php?r=Estadisticas/GetSubContarEspeciesFechaCuencaG&cuenca='+cuenca+'&fechaini='+fechainit +'&fechafin='+fechafint , function (data3){
	data3 = JSON.parse(data3);	
  ...
  series: [{
	...
	$('#pobEdad4').append('Cuenca: ' +cuenca.toLocaleString('en-EN', {maximumFractionDigits:0}) + "</td>");
...
$.get('index.php?r=Estadisticas/GetAreaParcela', function (data){
	...
	data = JSON.parse(data);
		$('#grafico21').highcharts({
            ...
            title: {
                text: 'Distribución de tareas segun tamaño de plantación (de menor a mayor)'
            },
            subtitle: {
            ...
            xAxis: {
              		 title: {
                    text: 'Número de parcelas con una superficie menor'
                }	
            },
            yAxis: {
				type:'logarithmic',
                title: {
                    text: 'Tarea de la plantación'
                }
            },
            legend: {
                enabled: false
...
$('#grafico21').highcharts({
 ...
 colors: ['#990000','#00ff00', '#0000ff', '#990000','#009900', '#000099', '#999900','#00ff99', '#9944ff'],
            ...
            title: {
                text: 'Dsitribucion de superficies de plantaciones'
            },
            subtitle: {
                text: document.ontouchstart === undefined ?
                    'Pulse y arrastre en el grafico para hacer zoom' : 'Pinch the chart to zoom in'
            ...
            xAxis: [{
                title: {
					text: 'Número de parcelas menores'
...
$('#grafico22').highcharts({
 ...
 colors: ['#990000','#00ff00', '#0000ff', '#990000','#009900', '#000099', '#999900','#00ff99', '#9944ff'],
            ...
            title: {
                text: 'Superficie plantada anualmente'
            },
            subtitle: {
                text: document.ontouchstart === undefined ?
                    'Pulse y arrastre en el grafico para hacer zoom' : 'Pinch the chart to zoom in'
...
$('#container11').highcharts({
    ...
    title: {
        text: 'Evolucion % superficie plantada por especie'
    },
    subtitle: {
        text: 'Fuente SPSO'
    },
