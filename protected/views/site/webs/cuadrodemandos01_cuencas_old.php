...
//alert ('año'+id2);
	...
	$.get('index.php?r=Estadisticas/GetSubCuencaTotalEspeciePlantar='+labort+'&cuenca='+cuenca+'&fechaini='+fechainit +'&fechafin='+fechafint , function (data3){
	...
	$("#Titulo2").append("<td>" +"Plantaciones (tareas o m)" + "</td>" );
