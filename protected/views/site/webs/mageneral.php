							  ...
							  <div class="row">
										...
										<div class="row">	
											<div class="col-md-6">
												...
												<h4 id="psTitulo94C" width="74%" class="p-3 mb-2 bg-danger   text-white  ".bg-success></h4>
												
												
												<!--<div id="grafico92"></div>-->
												<div class="table">
													<table id="psgrafico94C" class="table-striped bg-danger text-white" ></table>
												</div>
												<h4 id="psTitulo94D" width="74%" class="p-3 mb-2 bg-danger   text-white  ".bg-success></h4>
												
												
												<!--<div id="grafico92"></div>-->
												<div class="table">
													<table id="psgrafico94D" class="table-striped bg-danger text-white" ></table>
												</div>
										...
										<div class="row">	
											...
											<div class="col-md-8">
											    <h4 id="psTitulo103B" width="74%" class="p-3 mb-2 bg-danger   text-white  ".bg-success></h4>
												<!--<div id="grafico92"></div>-->
												<div class="table">
													<table id="psgrafico103B" class="table-striped bg-danger text-white" ></table>
												</div>
											</div>
										</div>
										<div class="row">	
											...
											<div class="col-md-8">
											    <h4 id="psTitulo103C" width="74%" class="p-3 mb-2 bg-danger   text-white  ".bg-success></h4>
												<!--<div id="grafico92"></div>-->
												<div class="table">
													<table id="psgrafico103C" class="table-striped bg-danger text-white" ></table>
												</div>
											</div>
										</div>
										<div class="row">	
...
<div class="pane ui-layout-west">
	...
	<label>Seguimiento por Cuenca</label>
		...
		<br/>
				...
				<br/>
				<select id="hiperAlcampo" name="hiperAlcampo" onchange="cargarGraficoAno(0)"></select>
		...
		<br/>
				...
				<button type="button" class="btn btn-primay" title="Calcular" onclick="cargarGraficoAno(0)">Buscar 
...
<!--INSERTO LIBRERIA PRINCIPAL-->
<script src="js/cargarmacadamiapsi.js" type="text/javascript"></script>
...
var nombreactividad="Sistema Agroforestal basado en Macadamia";
 ...
 */
 ...
 //ESTA FUNCION DISPARA TODO EL PROCESO UNA VEZ SE DA EL BOTON DE CALCULO
