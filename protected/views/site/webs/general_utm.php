...
//***********************
	...
	*/
	...
	map.on('pointermove', function(event) {
		...
		$('#coord').html(ol.coordinate.toStringXY(coord, 2) + "<br> WGS 84  PseudoMercator<br> " +ol.coordinate.toStringXY(sal, 6) + "<br> WGS 84  Geograficas<br>"+ol.coordinate.toStringXY(salid, 1) + "<br> WGS 84  UTM 19 N<br>"  );	
