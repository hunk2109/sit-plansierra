...
<div class="pane ui-layout-south">
	...
	<div class="row">
	  ...
	  <div class="col-md-2" style="background-color:lavender; border-style:none";>
	  <label>Actual</label>
	  ...
	  <div class="col-md-7"  >
		...
		<div class="col-md-3" style="background-color:lavender; border-style:none ">
...
var nombreactividad="Todas las incluidas en SPSO";
/*
var f = new Date();
...
$('#grafico91').highcharts({
    ...
    series: [{
		...
		//cuadro de avances 
       	...
       	$("#TituloA2").append("<td><h3><b>" +"Actividad de reforestación:  Avance / Meta = % de cumplimiento" + "</b></h3></td>" );
