	...
	<div style="width: 50%; height: 100%; float:right" >
		...
		<div id="grafico2" style ="height: 100%"></div>-->
		 ...
		 <ul class="nav nav-tabs">
								<li class="active"><a data-toggle="tab" href="#menu1">Subcuenca</a></li>
...
<div class="pane ui-layout-west">
	...
	<label>Seguimiento por Cuenca</label>
		...
		<br/>
				...
				<button type="button" class="btn btn-primay" title="Calcular" onclick="cargarGraficoAno()">Buscar 
...
?>
//ESTO ES PARA CARGAR EL DESPLEGABLE DE AÑOS.
...
$("#grafico80").append("</td>   <td ><h4><b>&nbsp; Fecha de consulta :&nbsp; " +dia+ ", (desde: " +finicial2+"&nbsp; a&nbsp;: "+ffinal2+"&nbsp;) </b></h4></td> " );
...
$('#grafico91').highcharts({
	...
	var c = 0, s =0;
	$('#Titulo92').empty();
		$("#Titulo92").append("<td><h4><b>" +" Fase de plantación ("+nombreactividad + ") </b></h4></td>" );
	$('#grafico92').empty();
	 var row = $("<tr />");
	...
	$('#Titulo93').empty();
	$("#grafico93").empty();
	$("#Titulo93").append("<td><h4><b><c>" +"Fase de plantación por Microcuenca (Tareas)" + "</c></b></h4></td>" );
...
//primera actividad
	...
	$("#Titulo104").append("<td><h4><b>" +"Grupo de especie (salidas vivero)" + "</b></h4></td>" );
	...
	//$("#Titulo104sub").append("<td><h5> Plantas</h5></td>" );
		...
		var row = $("<tr />");
		$("#grafico104").append(row); 
		row.append($("<td width=25% ><h5><b>Especies</b></h5></td>"));
		for (var i=0; i< data4.length; i++){
			row.append($("<td width=15%  ><h5><b>" + data4[i].tipo.toLocaleString('en-EN') + "</b></h5></td>"));	
			//row.append($("<td width=100><h5><b>Re</b></h5></td>"));
			//row.append($("<td width=20%><h5><b>Ma</b></h5></td>"));
		}
			row.append($("<td width=15% ><h5><b>" + "Total salidas." + "</b></h5></td>"));
	...
	*/
	...
	$("#Titulo102").empty();
	$("#grafico102").empty();
		$("#Titulo102").append("<td><h4><b>" +" Superficies resforestada por Municipios" + "<b></h4></td>" );
		...
		row.append($("<td><h4><b>TOTAL </b></h4></td>"));
			...
			row.append($("<td><h4><b>" + totalsup.toLocaleString('en-EN', {maximumFractionDigits:1}) + "</b></h4></td>"));
	$("#grafico102").append(row);
	})
	...
	$("#grafico94").empty();
	$("#grafico94B").empty();
	$("#Titulo94").append("<td><h4><b><center>"+"&nbsp;    Especies plantadas   &nbsp;"+nombreactividad + "</b></h4></td>" );
	...
	data4 = JSON.parse(data4);
		...
		row.append($("<td width=25% class=sucess colspan=1></td>"));
		row.append($("<td width=75% class=sucess colspan=5 ><h4><b> Tareas </b></h4></td>"));
		row.append($("<th></th>"));
	...
	$.get('index.php?r=Poa/GetProyectoTodoActividadSubcuenca&finicial='+finicial+'&ffinal='+ffinal+'&subcuenca='+subcuenca, function (data3){
	data3 = JSON.parse(data3);	
	var totalSup = 0;
	var totalNum = 0;
	var row = $("<tr />");
...
function cargarGraficoAnoMicroCuenca(){
	...
	$("#mgrafico80").append("</td>   <td ><h4><b>Fecha  : " +dia+ "    Año " +id2+ "   Microcuenca : "+microcuenca+" , Reforestación</b></h4></td> " );
	    $('#mgrafico90').empty();
		$('#mgrafico91').empty();
		$('#mgrafico92').empty();
		$('#mgrafico93').empty();
...
//$.get('index.php?r=Poa/GetAvanceSubcuenca&tipoactividad='+tipoactividad+'&ano='+ano+'&subcuenca='+idAlcampo, function (data){
$.get('index.php?r=Poa/GetAvanceMicrocuenca&tipoactividad='+tipoactividad+'&ano='+ano+'&microcuenca='+microcuenca, function (data){
...
$('#mgrafico91').highcharts({
   ...
   $.get('index.php?r=Poa/GetActividadActividadMicrocuenca&tipoactividad='+tipoactividad+'&ano='+ano+'&microcuenca='+microcuenca,  function (data3){
	data3 = JSON.parse(data3);	
	var totalSup = 0;
	var totalNum = 0;
	var row = $("<tr />");
	...
	$("#mTitulo92").empty();
	$('#mgrafico92').empty();
		$("#mTitulo92").append("<td><h5>" +" Tipo de Plantación" + "</h5></td>" );
	...
	$.get('index.php?r=Poa/GetActividadActividadMicrocuencaListadoParcelas&tipoactividad='+tipoactividad+'&ano='+ano+'&microcuenca='+microcuenca,  function (data3){
	data3 = JSON.parse(data3);	
	var totalSup = 0;
	var totalNum = 0;
	var row = $("<tr />");
	...
	$.get('index.php?r=Poa/GetEspecieActividadMicrocuenca&tipoactividad='+tipoactividad+'&ano='+ano+'&microcuenca='+microcuenca, function (data3){
	...
	$("#mTitulo104").empty();
	$("#mgrafico104").empty(); 
		$("#mTitulo104").append("<td><h5>" +"Grupo de especie (salidas vivero)" + "</h5></td>" );
	...
	$.get('index.php?r=Poa/GetMunicipioActividadMicrocuenca&tipoactividad='+tipoactividad+'&ano='+ano+'&microcuenca='+microcuenca, function (data3){
	data3 = JSON.parse(data3);	
	var totalSup = 0;
	var totalNum = 0;
	var row = $("<tr />");
	...
	$("#mTitulo102").empty();
	$("#mgrafico102").empty()
		$("#mTitulo102").append("<td><h5>" +" Municipios" + "</h5></td>" );
	...
	$.get('index.php?r=Poa/GetEspecieActividadPlantadasMicrocuenca&tipoactividad='+tipoactividad+'&ano='+ano+'&microcuenca='+microcuenca, function (data3){
	data3 = JSON.parse(data3);	
	var totalSup = 0;
	var totalNum = 0;
	var row = $("<tr />");
	...
	$("#mTitulo94").empty();
	$("#mgrafico94").empty();
		$("#mTitulo94").append("<td><h5>" +"Epecies plantadas" + "</h5></td>" );
	...
	$.get('index.php?r=Poa/GetProyectoActividadMicrocuenca&tipoactividad='+tipoactividad+'&ano='+ano+'&microcuenca='+microcuenca, function (data3){
	data3 = JSON.parse(data3);	
	var totalSup = 0;
	var totalNum = 0;
	var row = $("<tr />");
	...
	$("#mTitulo103").empty();
	$("#mgrafico103").empty();
		$("#mTitulo103").append("<td><h5>" +"Proyectos" + "</h5></td>" );
