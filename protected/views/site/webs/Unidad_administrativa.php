...
var iso1, iso2, iso3, iso4, iso5, provincias,municipios, municipio_selected,microcuencas_selected, plantaciones_cuencas_selected, parcelas, arg_cuencas, ensenas, loc = null, idAlcampo, idEncuesta, cuencas, microcuenca;
...
//AQUI RELLENO EL DESPLEGABLE DE TERMINO MUNICIPAL; ESTE EVENTO SE DISPARA CUANDO YA HE SELECCIONADO UNA Provincia ?
...
?>	
	...
	//CUANDO HE SELECCIONADO AÑO SE DISPARA ESTE EVENTO. QUE CARGA DATOS DE GRAFICOS
	...
	//CUANDO HE SELECCIONADO TERMINO MUNICIPAL SE  SE PINTA EL TEMINO MUNICIPAL.
	...
	//se pinta la microcuenca seleccionada
	        municipio_selected.getSource().setUrl("http://sit.plansierra.org/cgi-bin/mapserv.exe?MAP=c:\\datos/sierra/unidad_administrativa.map&municipio="+microcuenca+"&provincia="+idAlcampo);
	

$.get('index.php?r=Areas/getBoxTerMunicipal&x='+microcuenca+'&y='+idAlcampo, function( data10 ) {
...
<?php
//DESPLEGABLE DE LAS PROVINCIAS
//SE SIGUE GURADAN EN HIPERaLCAMPO
...
?>
	...
	var a = "<option value=999>Todas las provincias</option>";
	...
	*/
	...
	//*********************************
	 ...
	 municipio_selected = new ol.layer.Image({
		...
		url: 'http://sit.plansierra.org/cgi-bin/mapserv.exe?MAP=c:\\datos/sierra/unidad_administrativa.map&SERVICE=WMS&VERSION=1.3.0&REQUEST=GetLegendGraphic&FORMAT=image/png&SLD_VERSION=1.1.0&LAYER=MUNICIPIO_SELECTED',
		source: new ol.source.ImageWMS({
		url: 'http://sit.plansierra.org/cgi-bin/mapserv.exe?MAP=c:\\datos/sierra/unidad_administrativa.map',
		crossorigin: 'anonymous',
...
//**************************************************	
	...
	var unidad_administrativa2 = new ol.layer.Tile({
...
provincias = new ol.layer.Image({
	id: 'Provincias',
	name:'Provincias',
	opacity :'0.2',
	
	url: 'http://sit.plansierra.org/cgi-bin/mapserv.exe?MAP=c:\\datos/sierra/unidad_administrativa.map&SERVICE=WMS&VERSION=1.3.0&REQUEST=GetLegendGraphic&FORMAT=image/png&SLD_VERSION=1.1.0&LAYER=PROVINCIAS',
	source: new ol.source.ImageWMS({
		url: 'http://sit.plansierra.org/cgi-bin/mapserv.exe?MAP=c:\\datos/sierra/unidad_administrativa.map',
		crossorigin: 'anonymous',
		params: {'LAYERS': 'PROVINCIAS', 'SRS': "EPSG:3857" }
	})
})	

municipios = new ol.layer.Image({
	id: 'Municipios',
	name:'Municipios',
	opacity :'0.2',
	
	url: 'http://sit.plansierra.org/cgi-bin/mapserv.exe?MAP=c:\\datos/sierra/unidad_administrativa.map&SERVICE=WMS&VERSION=1.3.0&REQUEST=GetLegendGraphic&FORMAT=image/png&SLD_VERSION=1.1.0&LAYER=MUNIC',
	source: new ol.source.ImageWMS({
		url: 'http://sit.plansierra.org/cgi-bin/mapserv.exe?MAP=c:\\datos/sierra/unidad_administrativa.map',
		crossorigin: 'anonymous',
		params: {'LAYERS': 'MUNIC', 'SRS': "EPSG:3857" }
	})
})	
...
//***********************
	...
	layers.push(groupCapas30);
		...
		id: 'División Administrativa',
		name: 'División Administrativa',
		layers: [ provincias, municipios]
	});
