...
$(document).ready(function () {
	...
	map.setView(new ol.View({
            center:[sal[0],sal[1]],
			//Zoom constantea atamaño de parcela (podria calcularlo a partir de min y max)
            zoom: 17
     }));
...
*/			
	...
	//EVENTO ASOICADO AL RELLENO, EN ESTE CASO DEL PREDIO
...
//***********************
	...
	groupCapas = new ol.layer.Group({
		id: 'Plantaciones',
		name: 'Plantaciones',
		layers: [microcuencas_selected, arg_cuencas, parcelas, predio_selected, plantaciones_cuencas_selected, plantaciones_puntos ]
	});
