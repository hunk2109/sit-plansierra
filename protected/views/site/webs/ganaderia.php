...
function cargarGraficoAno(){
	...
	$("#grafico80").append("</td>   <td ><h3><b>Fecha de hoy : " +dia+ ",  datos desde el 1 de Enero (ATENCION datos correspondiente a 2018)   </b></h3></td> " );
		$('#grafico90').empty();
		$('#grafico91').empty();
		$('#grafico92').empty();
		$('#grafico93').empty();
...
$('#grafico90').highcharts({
        ...
        chart: {
			...
			title: {
				text: 'Lluvia mensual de los ultimos 12 meses(mm)'
			},
			subtitle: {
...
$('#grafico91').highcharts({
	...
	var c = 0, s =0;
	 ...
	 var row = $("<tr />");
		...
		row.append($("<th></th>"));
		row.append($("<td width=250><h4><b>Actividad</b></h5></td>"));
		
		row.append($("<td width=100><h4><b>Número</b></h5></td>"));
			var row = $("<tr />")	
			$("#grafico92").append(row); 
	...
	var c = 0, s =0;
	 ...
	 var row = $("<tr />");
		...
		row.append($("<th></th>"));
		row.append($("<td width=250><h4><b>Plantación</b></h5></td>"));
	...
	var c = 0, s =0;
	 ...
	 var row = $("<tr />");
		...
		row.append($("<th></th>"));
		row.append($("<td width=250><h4><b>Grupo</b></h5></td>"));
		
		row.append($("<td width=100><h4><b>Plantas</b></h5></td>"));
			var row = $("<tr />")	
			$("#grafico94").append(row); 
	...
	var c = 0, s =0;
		...
		row.append($("<th></th>"));
		row.append($("<td width=250><h4><b>Municipio</b></h5></td>"));
	...
	var c = 0, s =0;
	 ...
	 var row = $("<tr />");
		...
		row.append($("<th></th>"));
		row.append($("<td width=250><h4><b>Cuenca</b></h5></td>"));
