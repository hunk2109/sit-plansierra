...
var iso1, iso2, iso3, iso4, iso5, microcuencas_selected, municipio_selected, plantaciones_cuencas_selected, parcelas, arg_cuencas, ensenas, loc = null, idAlcampo, idEncuesta, cuencas, microcuenca, productores_ganaderos,centro_de_acopio,productor_ganadero_seleccionado,ips;
...
//AQUI RELLENO EL DESPLEGABLE DE CEDULAS
...
?>	
	...
	//se DEBE PINTRR EL TERMINO MUNICIPAL pinta la microcuenca seleccionada
	       municipio_selected.getSource().setUrl("http://sit.plansierra.org:81/cgi-bin/mapserv.exe?MAP=c:\\datos/sierra/unidad_administrativa.map&municipio="+microcuenca+"&provincia="+idAlcampo+"&distrito="+distrito);
...
//esto es para encender y apagar capas
	...
	//se pinta las parcelas	de la microcuenca seleccionada	
			//plantaciones_cuencas_selected.getSource().setUrl("http://sit.plansierra.org:81/cgi-bin/mapserv.exe?MAP=c:\\datos/sierra/especies.map&parcelassel="+microcuenca);
			//parcelas.getSource().setUrl("http://sit.plansierra.org:81/cgi-bin/mapserv.exe?MAP=c:\\datos/sierra/especies.map");
...
//DEFINICION DE CAPAS DEL MAPAQ
	...
	microcuencas_selected = new ol.layer.Image({
		...
		visible: true,
		url: 'http://sit.plansierra.org:81/cgi-bin/mapserv.exe?MAP=c:\\datos/sierra/catastro.map&cuencas=99&SERVICE=WMS&VERSION=1.3.0&REQUEST=GetLegendGraphic&FORMAT=image/png&SLD_VERSION=1.1.0&LAYER=MICROCUENCAS_SELECTED2',
		source: new ol.source.ImageWMS({
		url: 'http://sit.plansierra.org:81/cgi-bin/mapserv.exe?MAP=c:\\datos/sierra/catastro.map&cuencas=99',
		crossorigin: 'anonymous',
	...
	plantaciones_cuencas_selected = new ol.layer.Image({
		...
		source: new ol.source.ImageWMS({
		url: 'http://sit.plansierra.org:81/cgi-bin/mapserv.exe?MAP=c:\\datos/sierra/especies.map&criterio2='+text3,
		crossorigin: 'anonymous',
	...
	source: new ol.source.ImageWMS({
		...
		crossorigin: 'anonymous',
		params: {'LAYERS': 'IPS', 'SRS': "EPSG:3857"}
	...
	url: 'http://sit.plansierra.org:81/cgi-bin/mapserv.exe?MAP=c:\\datos/sierra/especies.map&SERVICE=WMS&VERSION=1.3.0&REQUEST=GetLegendGraphic&FORMAT=image/png&SLD_VERSION=1.1.0&LAYER=TODAS_LAS_PLANTACIONES',
	source: new ol.source.ImageWMS({
		url: 'http://sit.plansierra.org:81/cgi-bin/mapserv.exe?MAP=c:\\datos/sierra/especies.map',
		crossorigin: 'anonymous',
	...
	opacity :'0.75',
	visible: false,
	url: 'http://sit.plansierra.org:81/cgi-bin/mapserv.exe?MAP=c:\\datos/sierra/puntos.map&tipoactividad='+tipoactividad+'&SERVICE=WMS&VERSION=1.3.0&REQUEST=GetLegendGraphic&FORMAT=image/png&SLD_VERSION=1.1.0&LAYER=PLANTACIONES_PUNTOS_ACTIVIDAD',
	source: new ol.source.ImageWMS({
		url: 'http://sit.plansierra.org:81/cgi-bin/mapserv.exe?MAP=c:\\datos/sierra/puntos.map&tipoactividad='+tipoactividad,
		crossorigin: 'anonymous',
...
tipoactividad=3;
	...
	url: 'http://sit.plansierra.org:81/cgi-bin/mapserv.exe?MAP=c:\\datos/sierra/puntos.map&SERVICE=WMS&VERSION=1.3.0&REQUEST=GetLegendGraphic&FORMAT=image/png&SLD_VERSION=1.1.0&LAYER=PLANTACIONES_PUNTOS',
	source: new ol.source.ImageWMS({
		url: 'http://sit.plansierra.org:81/cgi-bin/mapserv.exe?MAP=c:\\datos/sierra/puntos.map',
		crossorigin: 'anonymous',
...
var mdt_srtm_sombreado = new ol.layer.Image({
	...
	visible: false,
	url: 'http://sit.plansierra.org:81/cgi-bin/mapserv.exe?MAP=c:\\datos/sierra/raster.map&SERVICE=WMS&VERSION=1.3.0&REQUEST=GetLegendGraphic&FORMAT=image/png&SLD_VERSION=1.1.0&LAYER=mdt_srtm_sombreado',
	source: new ol.source.ImageWMS({
		url: 'http://sit.plansierra.org:81/cgi-bin/mapserv.exe?MAP=c:\\datos/sierra/raster.map',
		crossorigin: 'anonymous',
		params: {
...
var mdt_srtm = new ol.layer.Image({
	...
	name:'mdt_srtm',
	visible: false,
	url: 'http://sit.plansierra.org:81/cgi-bin/mapserv.exe?MAP=c:\\datos/sierra/raster.map&SERVICE=WMS&VERSION=1.3.0&REQUEST=GetLegendGraphic&FORMAT=image/png&SLD_VERSION=1.1.0&LAYER=mdt_srtm',
...
embalses_general = new ol.layer.Image({
	...
	url: 'http://sit.plansierra.org:81/cgi-bin/mapserv.exe?MAP=c:\\datos/sierra/Basetopografica.map&SERVICE=WMS&VERSION=1.3.0&REQUEST=GetLegendGraphic&FORMAT=image/png&SLD_VERSION=1.1.0&LAYER=Embalses_general',
	source: new ol.source.ImageWMS({
		url: 'http://sit.plansierra.org:81/cgi-bin/mapserv.exe?MAP=c:\\datos/sierra/Basetopografica.map',
		crossorigin: 'anonymous',
...
productor_ganadero_seleccionado = new ol.layer.Image({
	...
	url: 'http://sit.plansierra.org:81/cgi-bin/mapserv.exe?MAP=c:\\datos/sierra/ganaderia.map&productor=0&SERVICE=WMS&VERSION=1.3.0&REQUEST=GetLegendGraphic&FORMAT=image/png&SLD_VERSION=1.1.0&LAYER=Productor_ganadero_seleccionado',
	source: new ol.source.ImageWMS({
		url: 'http://sit.plansierra.org:81/cgi-bin/mapserv.exe?MAP=c:\\datos/sierra/ganaderia.map&productor=0',
		crossorigin: 'anonymous',
...
productores_ganaderos = new ol.layer.Image({
	...
	opacity :'1',
	visible: false,
	url: 'http://sit.plansierra.org:81/cgi-bin/mapserv.exe?MAP=c:\\datos/sierra/ganaderia.map&SERVICE=WMS&VERSION=1.3.0&REQUEST=GetLegendGraphic&FORMAT=image/png&SLD_VERSION=1.1.0&LAYER=Productores_ganaderos',
	source: new ol.source.ImageWMS({
		url: 'http://sit.plansierra.org:81/cgi-bin/mapserv.exe?MAP=c:\\datos/sierra/ganaderia.map',
		crossorigin: 'anonymous',
...
centro_de_acopio = new ol.layer.Image({
	...
	opacity :'1',
	visible: false,
	url: 'http://sit.plansierra.org:81/cgi-bin/mapserv.exe?MAP=c:\\datos/sierra/ganaderia.map&SERVICE=WMS&VERSION=1.3.0&REQUEST=GetLegendGraphic&FORMAT=image/png&SLD_VERSION=1.1.0&LAYER=Centro_de_acopio',
	source: new ol.source.ImageWMS({
		url: 'http://sit.plansierra.org:81/cgi-bin/mapserv.exe?MAP=c:\\datos/sierra/ganaderia.map',
		crossorigin: 'anonymous',
	...
	opacity :'1',
	visible: false,
	url: 'http://sit.plansierra.org:81/cgi-bin/mapserv.exe?MAP=c:\\datos/sierra/ganaderia.map&SERVICE=WMS&VERSION=1.3.0&REQUEST=GetLegendGraphic&FORMAT=image/png&SLD_VERSION=1.1.0&LAYER=Lagunas',
	source: new ol.source.ImageWMS({
		url: 'http://sit.plansierra.org:81/cgi-bin/mapserv.exe?MAP=c:\\datos/sierra/ganaderia.map',
		crossorigin: 'anonymous',
...
osm_viario = new ol.layer.Image({
	...
	url: 'http://sit.plansierra.org:81/cgi-bin/mapserv.exe?MAP=c:\\datos/sierra/OSMBasetopografica.map&SERVICE=WMS&VERSION=1.3.0&REQUEST=GetLegendGraphic&FORMAT=image/png&SLD_VERSION=1.1.0&LAYER=osm_viario',
	source: new ol.source.ImageWMS({
		url: 'http://sit.plansierra.org:81/cgi-bin/mapserv.exe?MAP=c:\\datos/sierra/OSMBasetopografica.map',
		crossorigin: 'anonymous',
	...
	opacity :'1',
	visible: false,
	url: 'http://sit.plansierra.org:81/cgi-bin/mapserv.exe?MAP=c:\\datos/sierra/ganaderia.map&SERVICE=WMS&VERSION=1.3.0&REQUEST=GetLegendGraphic&FORMAT=image/png&SLD_VERSION=1.1.0&LAYER=Reservorio',
	source: new ol.source.ImageWMS({
		url: 'http://sit.plansierra.org:81/cgi-bin/mapserv.exe?MAP=c:\\datos/sierra/ganaderia.map',
		crossorigin: 'anonymous',
	...
	opacity :'1',
	visible: false,
	url: 'http://sit.plansierra.org:81/cgi-bin/mapserv.exe?MAP=c:\\datos/sierra/ganaderia.map&SERVICE=WMS&VERSION=1.3.0&REQUEST=GetLegendGraphic&FORMAT=image/png&SLD_VERSION=1.1.0&LAYER=Sistema de riego',
	source: new ol.source.ImageWMS({
		url: 'http://sit.plansierra.org:81/cgi-bin/mapserv.exe?MAP=c:\\datos/sierra/ganaderia.map',
		crossorigin: 'anonymous',
...
// TAB-3-			
		    ...
		    productor_ganadero_seleccionado.getSource().setUrl("http://sit.plansierra.org:81/cgi-bin/mapserv.exe?MAP=c:\\datos/sierra/ganaderia.map&productor="+idPuntos);
...
// alert ('esto es :'+textfin+'    '+text2);
 plantaciones_cuencas_selected.getSource().setUrl("http://sit.plansierra.org:81/cgi-bin/mapserv.exe?MAP=c:\\datos/sierra/especies.map&criterio2="+textfin);
...
//AQUI SE GENERA LA TABLA
 $.get('index.php?r=Poa/GetActividadFacturacionLabores&criterio='+crite, function (data3){
	...
	$('#Grafico_1_1 tbody').on ('click', 'tr' , function() {
		  ...
		  //plantaciones_cuencas_selected.getSource().setUrl("http://sit.plansierra.org:81/cgi-bin/mapserv.exe?MAP=c:\\datos/sierra/especies.map&parcelassel="+seccion);
...
$('#menuproductor').selectmenu({
		change: function( event, data ) {
		    ...
		    productor_ganadero_seleccionado.getSource().setUrl("http://sit.plansierra.org:81/cgi-bin/mapserv.exe?MAP=c:\\datos/sierra/ganaderia.map&productor="+idAlcampo);
...
?>	
	...
	//se pinta la microcuenca seleccionada
	        microcuencas_selected.getSource().setUrl("http://sit.plansierra.org:81/cgi-bin/mapserv.exe?MAP=c:\\datos/sierra/catastro.map&cuencas="+microcuenca);
