<div class="pane ui-layout-south">
	...
	<div class="row">
	  ...
	  <label>General Silvopastoriles</label>
...
$('#grafico91').highcharts({
	...
	var c = 0, s =0;
		...
		$("#Titulo92").append("<td>" +grupo0 + "</td>" );
	
	 var row = $("<tr />");
		$("#grafico92").append(row); 
		row.append($("<th></th>"));
		row.append($("<td width=250><h4><b>"+grupo0+" (unidad)</b></h5></td>"));
		
		row.append($("<td width=100><h4><b>Valor</b></h5></td>"));
			var row = $("<tr />")	
			$("#grafico92").append(row); 
	...
	var c = 0, s =0;
		...
		$("#Titulo93").append("<td>" +grupo1 + "</td>" );
	
	 var row = $("<tr />");
		$("#grafico93").append(row); 
		row.append($("<th></th>"));
		row.append($("<td width=250><h4><b>"+grupo1+" (unidad)</b></h5></td>"));
	...
	var c = 0, s =0;
		...
		$("#Titulo94").append("<td>" +grupo2 + "</td>" );
	
	 var row = $("<tr />");
		$("#grafico94").append(row); 
		row.append($("<th></th>"));
		row.append($("<td width=250><h4><b>"+grupo2+" (unidad)</b></h5></td>"));
	...
	var c = 0, s =0;
		...
		$("#Titulo103").append("<td>" +grupo3 + "</td>" );
	
	 var row = $("<tr />");
		$("#grafico103").append(row); 
		row.append($("<th></th>"));
		row.append($("<td width=250><h4><b>"+grupo3+" (unidad)</b></h5></td>"));
	...
	var c = 0, s =0;
		...
		$("#Titulo104").append("<td>" +grupo4 + "</td>" );
	
	 var row = $("<tr />");
		$("#grafico104").append(row); 
		row.append($("<th></th>"));
		row.append($("<td width=250><h4><b>"+grupo4+" (unidad)</b></h5></td>"));
