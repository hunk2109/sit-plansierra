...
function cargarGraficoAno(){
	...
	$("#grafico80").append("</td>   <td ><h3><b>&nbsp; Fecha de consulta : " +dia+ ", (desde 1-Enero-" +anoconsulta+")&nbsp; </b></h3></td> " );
...
$('#grafico91').highcharts({
	...
	var c = 0, s =0;
		...
		$("#Titulo92").append("<td><h5>" +" Tipo actividad de &nbsp;"+nombreactividad + "</h5></td>" );
	$('#grafico92').empty();
	 var row = $("<tr />");
		...
		row.append($("<td width=30%><h5><b>Plantaciones</b></h5></td>"));
		row.append($("<td width=30%><h5><b>Tareas</b></h5></td>"));
			var row = $("<tr />")	
			$("#grafico92").append(row); 
	...
	var i = 0;
	var c = 0, s =0;
	$.get('index.php?r=Poa/GetActividadActividad&tipoactividad='+tipoactividad, function (data4){
	data4 = JSON.parse(data4);
		$.get('index.php?r=Poa/GetSubcuencasActividad&tipoactividad='+tipoactividad, function (data5){
			data5 = JSON.parse(data5);

	
		$("#Titulo93").append("<td><h5>" +"Tipo de Actividad por Subcuenca (Tareas)" + "</h5></td>" );
	...
	$.get('index.php?r=Poa/GetActividadActividad&tipoactividad='+tipoactividad, function (data4){
	data4 = JSON.parse(data4);
		$.get('index.php?r=Poa/GetEspecieUtilizadasActividad&tipoactividad='+tipoactividad, function (data5){
			data5 = JSON.parse(data5);
	...
	var c = 0, s =0;
		...
		$("#Titulo102").append("<td><h5>" +" Superficies resforestada por Municipios" + "</h5></td>" );
	...
	data4 = JSON.parse(data4);
		...
		$("#Titulo94").append("<td><h5>" +"Especies plantadas en la actividad de  &nbsp;"+nombreactividad + "</h5></td>" );
		 var row = $("<tr />");
	...
	var c = 0, s =0;
		...
		$("#Titulo103").append("<td><h5>" +"Superficie de reforestación por fondo" + "</h5></td>" );
