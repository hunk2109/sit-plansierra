...
$('#grafico101').highcharts({
	...
	$.get('index.php?r=Poa/GetTecnicoActividad', function (data){
...
$('#grafico100').highcharts({
	...
	$.get('index.php?r=Poa/GetAvanceAnoActual', function (data){
...
$('#grafico91').highcharts({
	...
	//$.get('index.php?r=Poa/GetActividadActividad&tipoactividad='+tipoactividad, function (data3){
		$.get('index.php?r=Poa/GetActividadAnoActual', function (data3){
	...
	var c = 0, s =0;
		...
		$("#Titulo92").append("<td><h5>" +" Tipo de Actividad" + "</h5></td>" );
	$('#grafico92').empty();
	 var row = $("<tr />");
	...
	$.get('index.php?r=Poa/GetActividadActividadSubcuencasAnoActual', function (data3){
	data3 = JSON.parse(data3);	
	var totalSup = 0;
	var totalNum = 0;
	var row = $("<tr />");
	...
	$.get('index.php?r=Poa/GetEspecieActividadAnoActual', function (data3){
	data3 = JSON.parse(data3);	
	var totalSup = 0;
	var totalNum = 0;
	var row = $("<tr />");
	...
	$.get('index.php?r=Poa/GetMunicipioAnoActual', function (data3){
	data3 = JSON.parse(data3);	
	var totalSup = 0;
	var totalNum = 0;
	var row = $("<tr />");
	...
	$.get('index.php?r=Poa/GetEspecieActividadPlantadasAnoActual', function (data3){
	data3 = JSON.parse(data3);	
	var totalSup = 0;
	var totalNum = 0;
	var row = $("<tr />");
	...
	var c = 0, s =0;
		...
		$("#Titulo94").append("<td><h5>" +"Especies plantadas" + "</h5></td>" );
	...
	$.get('index.php?r=Poa/GetProyectoAnoActual', function (data3){
	data3 = JSON.parse(data3);	
	var totalSup = 0;
	var totalNum = 0;
	var row = $("<tr />");
