...
$highestRow = $sheet->getHighestRow();
for($colum=1;$colum<=$highestRow;$colum++){
$g=$sheet->getCell($row.$colum)->getCalculatedValue();
echo '<br>';
echo $colum;
echo $g;
...
*
echo "</br>";
$SQL_fecha = "SELECT   max(id) FROM   public.gs_metas_fomento;";
$result  = pg_query($conn, $SQL_fecha);
//$row_muestreo = pg_fetch_array($result);
//$fecha_max = $row_muestreo[0];
...
$contador=10000;
$primeralinea=6;
$titulo=$primeralinea-2;
$asociacion_1=$sheet->getCell('B'.$titulo)->getCalculatedValue();
for($i = 6; $i<=$highestRow; $i++){
	$fid = $sheet->getCell('A'.$i)->getCalculatedValue();	
	if (is_numeric($fid)){
		$productor = $sheet->getCell('B'.$i)->getCalculatedValue();
		$cedula = $sheet->getCell('C'.$i)->getCalculatedValue();
		$Asociacion_2 = $sheet->getCell('D'.$i)->getCalculatedValue();
		$coord_x = $sheet->getCell('E'.$i)->getCalculatedValue();
		$coord_y = $sheet->getCell('F'.$i)->getCalculatedValue();
		$g=$sheet->getCell('G'.$i)->getCalculatedValue();
		$h=$sheet->getCell('H'.$i)->getCalculatedValue();
		$i=$sheet->getCell('I'.$i)->getCalculatedValue();
		$j=$sheet->getCell('J'.$i)->getCalculatedValue();
		$k=$sheet->getCell('K'.$i)->getCalculatedValue();
		$l=$sheet->getCell('L'.$i)->getCalculatedValue();
		$m=$sheet->getCell('M'.$i)->getCalculatedValue();
		$n=$sheet->getCell('N'.$i)->getCalculatedValue();
		$o=$sheet->getCell('O'.$i)->getCalculatedValue();
		$p=$sheet->getCell('P'.$i)->getCalculatedValue();
		$q=$sheet->getCell('Q'.$i)->getCalculatedValue();
		$r=$sheet->getCell('R'.$i)->getCalculatedValue();
		$s=$sheet->getCell('S'.$i)->getCalculatedValue();
		$t=$sheet->getCell('T'.$i)->getCalculatedValue();
		$u=$sheet->getCell('U'.$i)->getCalculatedValue();
		$v=$sheet->getCell('V'.$i)->getCalculatedValue();
		$w=$sheet->getCell('W'.$i)->getCalculatedValue();
		$x=$sheet->getCell('g'.$i)->getCalculatedValue();
		$x=$sheet->getCell('W'.$i)->getCalculatedValue();
		$y=$sheet->getCell('Y'.$i)->getCalculatedValue();
		$z=$sheet->getCell('Z'.$i)->getCalculatedValue();
		
		$SQL_gs ="INSERT INTO gs_metas_fomento (id, variable, valor) VALUES ('".$contador." , A , ".$A.");";
		pg_query($conn, $SQL_gs);
	}
