		...
		<div id="popup-content2">
			<div id="tabs2">
				...
				<div id="tabs2-1">	
										...
										<div class="row">
											<div class="agenciaforestal" id="grafico79" border="none" >
										...
										<div class="row">	
											...
											<div class="col-md-8">
											    <h4 id="TituloA2" width="74%" class="p-3 mb-2 bg-danger   text-white  ".bg-success></h4>
										...
										<div class="row">	
											...
											<div class="col-md-6">
												...
												<!--<div id="grafico92"></div>-->
												<h4 id="Titulo93sub" width="74%" class="p-3 mb-2 bg-secondary   text-white  ".bg-success></h4>
												<div class="table">
													<table id="grafico93" class="table-striped bg-danger text-white" ></table>
												</div>
												 <h4 id="Titulo93bis" width="74%" class="p-3 mb-2 bg-secondary   text-white  ".bg-success></h4>
												<!--<div id="grafico92"></div>-->
												<div class="table">
													<table id="grafico93bis" class="table-striped bg-danger text-white" ></table>
												</div>
											</div>
											</div>
											<div class="row">
										...
										<div class="row">
											<div class="col-md-6">
												...
												<h4 id="Titulo104sub" width="74%" class="p-3 mb-2 bg-secondary   text-white  ".bg-success></h4>
												<!--<div id="grafico92"></div>-->
												<div class="table">
													<table id="grafico104" class="table-striped bg-danger text-white" ></table>
												</div>
												 <h4 id="Titulo104bis" width="74%" class="p-3 mb-2 bg-secondary   text-white  ".bg-success></h4>
												<!--<div id="grafico92"></div>-->
												<div class="table">
													<table id="grafico104bis" class="table-striped bg-danger text-white" ></table>
												</div>
											</div>
...
var fi = new Date();
	...
	*/
var nombreactividad="Reforestación";
/*
var f = new Date();
...
function cargarGraficoAno(){
	...
	var ffinal1 =$("#fechafin").val();
	var finicial1 =$("#fechaini").val();
	var ffinal2 = ffinal1.split('-').reverse().join('/');
	var finicial2 = finicial1.split('-').reverse().join('/');
...
//alert (f);
	...
	//$("#grafico80").append("</td>   <td ><h4><b>&nbsp; Fecha de consulta :&nbsp; " +dia+ " </b></h4></td> " );
	//$("#grafico80_A").html('<img id="loading-image" width=200 src="images/logo3_75_75.gif" alt="Loading..." />');
	$("#grafico79").append("<agenciaforestal td width=1200px><h2	 align='left' style='color:darkred;'> <b><i >&nbsp;       Agencia Forestal&nbsp;</i></b></h2></td> ");
	$("#grafico80").append("</td>   <td ><h3><b>&nbsp; Fecha de consulta:  Del &nbsp; " +finicial2+"&nbsp; al   &nbsp; "+ffinal2+"&nbsp; </b></h3></td> " );
		
	//$("#grafico80").append("</td>   <td ><h3><b>&nbsp; Fecha de consulta:  Del &nbsp; " +finicial2+"&nbsp; a la fecha &nbsp; "+ffinal2+"&nbsp; </b></h3></td> " );	
		$('#grafico80_A').empty();
		$('#grafico90').empty();
		$('#grafico91').empty();
		$('#grafico92').empty();
...
//(((((((((((((((((((((((((((((((((((((((((((((((((((((((())))))))))))))))))))))))))))))))))))))))))))))))))))))))
	...
	var c = 0, s =0;
		...
		$("#Titulo92").append("<td><h3><b>" +" Tipo de actividad de reforestación  </b></h3></td>" );
	$('#grafico92').empty();
	 var row = $("<tr />");
		...
		///OJO quito totales por indicacion de alf_jim
			/*row.append($("<td><h4 style='color:darkred;' ><b><i>"+ "TOTAL" +"</i></b></h4></td>"));
			
			for (var j=0; j < 2; j++){
			row.append($("<td><h4><b><h4 style='color:darkred;' ><b><i>" + sumatotales[j].toLocaleString('en-EN', {maximumFractionDigits:1}) + "</b></h4></td>"));	
			}
		var row = $("<tr />");
	...
	$("#Titulo93").append("<td><h3><b><c>" +"Tipo de actividad por Subcuenca (Tareas)</c></b></h3></td>" );
...
//primera actividad
	...
	data4 = JSON.parse(data4);
		...
		$("#Titulo93bis").append("<td><h5>" +data4[0].actividad+ "</h5></td>" );
	...
	$("#Titulo104").append("<td><h3><b>" +"Salidas de plantas del vivero por especie </b></h3></td>" );
...
$.get('index.php?r=Poa/GetEspecieActividad&tipoactividad=0&tipoactividadsec='+tipoactividadsec+'&finicial='+finicial+'&ffinal='+ffinal, function (data3){
	...
	var c = 0, s =0;
		...
		$("#Titulo102").append("<td><h3><b>" +" Superficie reforestada por Municipio" + "<b></h3></td>" );
	...
	//especies plantadas
	$("#Titulo94").append("<td><h3><b><center>"+"&nbsp;    Especies plantadas en la actividad de reforestación</b></h3></td>" );
	...
	//POR DESTINO
	$("#Titulo95").append("<td witdht=100%><h3><b>Superficie de reforestación segun el destino de la reforestación" + "</center></b></h3></td>" );
	//////////////////////////////////////////////////////
	//////////////////////////////////////////////////////////////////////////////
		...
		for (var l=0; l < (2+2*data4.length);l++){
			sumatotales[l]=0;
				...
				for (var i=0; i < data5.length; i++){
					...
					//bucle de tipo de plantacion
					if (data5[i].familia == 'Café' || data5[i].familia == 'Otros materiales' || data5[i].familia == 'Semillas') {
					nose=1;
				} else {
	...
	var c = 0, s =0;
		...
		$("#Titulo103").append("<td><h3><b>" +"Superficie de reforestación por Fondo" + "</b></h3></td>" );
