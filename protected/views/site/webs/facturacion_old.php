...
<div id="Unidad" class="tabcontent">
  ...
  <a href="javascript:document.location.reload();">       Refrescar</a>
		...
		<div class="row">
			<div class="row" >
				<input type="checkbox" name="checksubcuenca" value= 1><label>  Subcuenca</label>
			</div>
			<div class="row" >	
		...
		<div class="row">
			<div class="row" >
				<input type="checkbox" name="checkmicrocuenca" value= 1><label>__Microcuenca</label>
			</div>
			<div class="row" >
		...
		<div class="row">
			<div class="row" >
				<input type="checkbox" name="checkcedula" value= 1><label>  Cédula cliente</label>
			</div>
			<div class="row" >
				
				<select id="cedula" name="cedula"></select>
			</div>
			<br/>
		</div>	
		<div class="row">
			<div class="row" >
				<input type="checkbox" name="checkplantacion" value= 1><label>  Plantacion</label>
			</div>
			<div class="row" >
				
				<select id="plantacion" name="plantacion"></select>
			</div>
			<br/>
		</div>	
		<div class="row">
			<div class="row" >
				<input type="checkbox" name="checkpredio" value= 1><label>  Predio</label>
			</div>
			<div class="row" >
		 ...
		 <div class="row">
			<div class="row" >
				<input type="checkbox" name="checkproyecto" value= 1><label>  Proyecto</label>
			</div>
			<div class="row" >
		...
		<div class="row">
			<div class="row" >
				<input type="checkbox" name="checkdestino" value= 1><label>  Destino</label>
			</div>
			<div class="row" >
		...
		<div class="row">
			<div class="row" >
				<input type="checkbox" name="checktipoactividad" value= 1><label>  Tipo Actividad</label>
			</div>
			<div class="row" >
		...
		<div class="row">
			<div class="row" >
				<input type="checkbox" name="checktipoplantacion" value= 1><label>  Tipo Plantación</label>
			</div>
			<div class="row" >
		...
		<div class="row">
			<div class="row" >
				<input type="checkbox" name="checkdestino" value= 0><label>  Fecha</label>
			</div>
			<div class="row" >
		...
		<div class="row">
			<div class="row" >
				<input type="checkbox" name="checkfactura" value= 1><label>  Factura</label>
			</div>
			<div class="row" >
...
FROM 
  ...
  ORDER BY  pv_cliente.cedula;') as $fila4) {
...
// TERMINADO EL RELLENO DE COMBOS
...
?>	
	...
	$.get("index.php?r=CartoBase/GetElevacion&x=7777777&y=99999999", function( data10 ) {
...
////////////////////////
	...
	// ESTO ES LO CORRESPONISENTE A PRODUCTOR
...
?>
	...
	data = <?php echo json_encode($rs3);?>;
	//var a = "<option value=999>Todas las subcuencas</option>";
	$("#menuproductor").append(a);
	for(var i = 0; i < data.length; i++){
		$('#menuproductor').append($('<option>', {
				value: data[i].id,
				text: data[i].id+ '- '+ data[i].nombre
			}));
...
//aquir se acaba por productor
	
	
	//////////////////////////
	
//ESTO ES PARA CUENCAS
