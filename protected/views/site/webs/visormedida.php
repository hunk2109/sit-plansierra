...
<div class="tab">
  ...
  <button class="tablinks" onclick="openBusca(event, 'Unidad')"><h5>Criterios de localizacion</h5></button>
  ...
  <button class="tablinks" onclick="openBusca(event, 'Parcela')"><h5>Parcela</h5></button>-->
   <button class="tablinks" onclick="openBusca(event, 'Recoger')"><h5>Recoger</h5></button>
</div>
...
<div id="Unidad" class="tabcontent">
  <h4>Unidad Administrativa</h4>
		...
		<br/>	
		<select id="menucuenca" name="hiperAlcampo"></select>
		//<a href="javascript:document.location.reload();">       Refrescar</a>
		<br/>
		<label>Seleccione  Subcuencal</label>
		<br/>
		<select id="menumicrocuenca" name="microcuenca"></select>
		<br/>	<br/>
		 <h4>Productor ganadero</h4>
	
		<label>Seleccione  por nombre de productor gansdero</label>
		<br/>
		<select id="menuproductor" name="hiperAlcampo"></select>
		<a href="javascript:document.location.reload();">       Refrescar</a>
		<br/>
		<label>Seleccione por cedula de productor ganadero</label>
		<br/>
		<select id="menucedula" name="microcuenca"></select>
		<br/>
...
<div id="Recoger" class="tabcontent">
...
//***********************
	...
	groupCapas40 = new ol.layer.Group({
		id: 'Ganadería',
		name: 'Ganadería',
		layers: [ groupCapas41, centro_de_acopio,productor_ganadero_seleccionado, productores_ganaderos,vector]
	});
