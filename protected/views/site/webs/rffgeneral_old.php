...
//(((((((((((((((((((((((((((((((((((((((((((((((((((((((())))))))))))))))))))))))))))))))))))))))))))))))))))))))
	...
	var c = 0, s =0;
		...
		$("#Titulo92").append("<td><h3><b>" +" Fase de plantación ("+nombreactividad + ") </b></h3></td>" );
	$('#grafico92').empty();
	 var row = $("<tr />");
	...
	$("#Titulo93").append("<td><h3><b>" +"Fase de plantación por Subcuenca (Tareas)" + "</b></h3></td>" );
...
//primera actividad
	...
	$("#Titulo104").append("<td><h3><b>" +"Grupo de especie (salidas vivero)" + "</b></h3></td>" );
...
$.get('index.php?r=Poa/GetEspecieActividad&tipoactividad=0&tipoactividadsec='+tipoactividadsec+'&finicial='+finicial+'&ffinal='+ffinal, function (data3){
	...
	var c = 0, s =0;
		...
		$("#Titulo102").append("<td><h3><b>" +" Superficies resforestada por Municipios" + "</b></h3></td>" );
	...
	$("#Titulo94").append("<td><h3><b>" +"Especies plantadas   &nbsp;"+nombreactividad + "</b></h4></td>" );
	...
	//$("#Titulo94sub").append("<td><h5> Plantas </h5></td>" );
		...
		/*for (var i=0; i< data4.length; i++){
			row.append($("<td width=10%><h5><b>" + data4[i].tipo.toLocaleString('en-EN') + "</b></h5></td>"));	
			//row.append($("<td width=100><h5><b>Re</b></h5></td>"));
			//row.append($("<td width=20%><h5><b>Ma</b></h5></td>"));
		}
			row.append($("<td width=10%><h5><b>" + "Total tareas" + "</b></h5></td>"));	*/
			var row = $("<tr />")	
			$("#grafico94").append(row); 
		...
		/*for (var i=0; i< data4.length; i++){
			...
			row.append($("<td width=10%><h5><b>" + "Total plantas" + "</b></h5></td>"));*/
		...
		for (var i=0; i< data4.length; i++){
			row.append($("<td width=15%><h4><b>" + data4[i].tipo.toLocaleString('en-EN') + "</b></h4></td>"));	
			//row.append($("<td width=100><h5><b>Re</b></h5></td>"));
			//row.append($("<td width=15%><h5><b>Ma</b></h5></td>"));
		}
	...
	//POR DESTINO
	$("#Titulo95").append("<td witdht=100%><h3><b><center>" +"Superficie de reforestación por destino" + "</center></b></h3></td>" );
	//////////////////////////////////////////////////////
	//////////////////////////////////////////////////////////////////////////////
