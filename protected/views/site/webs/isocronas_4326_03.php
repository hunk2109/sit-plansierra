...
var iso1, iso2, iso3, iso4, iso5, microcuencas_selected, plantaciones_cuencas_selected, parcelas, arg_cuencas, ensenas, loc = null, idAlcampo, idEncuesta, cuencas;
var sel, selLayer, osm, google, google_carto,parcelassel;
...
//***********************
	...
	groupCapas = new ol.layer.Group({
		id: 'isocronas',
		name: 'Cuencas',
		layers: [microcuencas_selected, arg_cuencas, parcelas, plantaciones_cuencas_selected  ]
	});
