...
if (tipoactividad != 0) {
	if (text != ''){
		...
		text = text +' AND tp_descripcio_tipo_actividad =\''+nombreactividad+'\'';
		text2 = text2 +' AND tp_descripcio_tipo_actividad =\''+nombreactividad+'\''
	} else {
		text = 'tp_descripcio_tipo_actividad =\''+nombreactividad+'\'';
		text2 = 'tp_descripcio_tipo_actividad =\''+nombreactividad+'\''
	}	
}
